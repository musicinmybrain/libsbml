...
namespace LibSBMLCSTest.xml {
  ...
  public class TestXMLOutputStream {
    ...
    public void test_XMLOutputStream_accessWithNULL()
    {
      assertTrue( new  XMLOutputStream(libsbml.cout,null,false) == null );
      assertTrue( new  XMLOutputStream(libsbml.cout,null,false,null,null) == null );
      OStringStream oss = new OStringStream();
      assertTrue( new  XMLOutputStream(oss,null,false) == null );
      OStringStream oss = new OStringStream();
      assertTrue( new  XMLOutputStream(oss,null,false,null,null) == null );
      assertTrue( new  XMLOutputStream(new  OFStream(null),null,false) == null );
      assertTrue( new  XMLOutputStream(new  OFStream(null),null,false,null,null) == null );
      null.downIndent();
      null.endElement(null);
      null.endElementTriple(null);
      assertTrue( oss.str() == null );
      null.setAutoIndent(0);
      null.startElement(null);
      null.startElementTriple(null);
      null.startEndElement(null);
      null.startEndElementTriple(null);
      null.upIndent();
      null.writeAttribute(null,0);
      null.writeAttribute(null,0);
      null.writeAttribute(null,null);
      null.writeAttribute(null,null);
      null.writeAttribute(null,0.0);
      null.writeAttribute(null,0.0);
      null.writeAttribute(null,0);
      null.writeAttribute(null,0);
      null.writeAttribute(null,0);
      ...
      null.writeAttribute(null,0);
      null.writeAttribute(null,0);
      null.writeChars(null);
      null.writeDouble(0.0);
      null.writeLong(0);
      null.writeXMLDecl();
    }
