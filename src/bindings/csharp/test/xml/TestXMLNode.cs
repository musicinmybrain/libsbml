...
namespace LibSBMLCSTest.xml {
  ...
  public class TestXMLNode {
    ...
    public void test_XMLNode_createElement()
    {
      ...
      assertTrue( (  "value" != test ) == false );
      test = null;
      test = cattr.getPrefix(0);
      assertTrue( ( prefix != test ) == false );
      test = null;
      test = cattr.getURI(0);
      assertTrue( ( uri != test ) == false );
      test = null;
      triple = null;
      attr = null;
      ns = null;
    ...
    public void test_XMLNode_hasChild()
    {
      string xmlstr = "<annotation>\n" + "  <test xmlns=\"http://test.org/\" id=\"test\">test</test>\n" + "</annotation>";
      XMLNode node = new XMLNode();
      assertTrue( node.hasChild( "test") == (int)false );
      node = null;
      node = XMLNode.convertStringToXMLNode(xmlstr,null);
      assertTrue( node.hasChild( "test") == (int)true );
      node = null;
    }
