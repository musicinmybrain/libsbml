...
namespace LibSBMLCSTest.annotation {
  ...
  assertTrue( msg ==  "" );
    ...
    public void test_NestedCVTerm_assignmentOperator()
    {
      ...
      assertTrue( CVTermN.getResources().getValue(0) ==  "nested resource" );
      ...
      assertTrue( CVTerm1.getNestedCVTerm(0).getResources().getValue(0) ==  "nested resource" );
      CVTerm CVTerm2 = new CVTerm();
      CVTerm2 = CVTerm1;
      assertTrue( CVTerm2.getQualifierType() == libsbml.BIOLOGICAL_QUALIFIER );
      assertTrue( CVTerm2.getResources().getLength() == 1 );
      ...
      assertTrue( CVTerm2.getNestedCVTerm(0).getResources().getValue(0) ==  "nested resource" );
      CVTerm2 = null;
      CVTerm1 = null;
      CVTermN = null;
    }
