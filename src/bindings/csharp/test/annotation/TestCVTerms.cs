...
namespace LibSBMLCSTest.annotation {
  ...
  public class TestCVTerms {
    ...
    public void test_CVTerm_addNestedCVTerm()
    {
      ...
      assertTrue((  "rdf:resource" == name ));
      assertTrue((  "nested" == value ));
      name = null;
      value = null;
      term1 = null;
      term = null;
    ...
    public void test_CVTerm_createFromNode()
    {
      ...
      string value = xa.getValue(0);
      assertTrue((  "rdf:resource" == name ));
      assertTrue((  "This is my resource" == value ));
      name = null;
      value = null;
      qual_triple = null;
      bag_triple = null;
    ...
    public void test_CVTerm_createFromNode_Nested()
    {
      ...
      value = xa.getValue(0);
      assertTrue((  "rdf:resource" == name ));
      assertTrue((  "This is my nested resource" == value ));
      name = null;
      value = null;
    ...
    public void test_CVTerm_getResources()
    {
      ...
      assertTrue((  "GO6666" == res1 ));
      assertTrue((  "OtherURI" == res2 ));
      res1 = null;
      res2 = null;
      term = null;
    }
    ...
    public void test_CVTerm_get_biol_qualifiers()
    {
      ...
      assertTrue( (  "is" != libsbml.BQB_IS.toString() ) == false );
      assertTrue( (  "hasPart" != libsbml.BQB_HAS_PART.toString() ) == false );
      assertTrue( (  "isPartOf" != libsbml.BQB_IS_PART_OF.toString() ) == false );
      assertTrue( (  "isVersionOf" != libsbml.BQB_IS_VERSION_OF.toString() ) == false );
      assertTrue( (  "hasVersion" != libsbml.BQB_HAS_VERSION.toString() ) == false );
      assertTrue( (  "isHomologTo" != libsbml.BQB_IS_HOMOLOG_TO.toString() ) == false );
      assertTrue( (  "isDescribedBy" != libsbml.BQB_IS_DESCRIBED_BY.toString() ) == false );
      assertTrue( (  "isEncodedBy" != libsbml.BQB_IS_ENCODED_BY.toString() ) == false );
      assertTrue( (  "encodes" != libsbml.BQB_ENCODES.toString() ) == false );
      assertTrue( (  "occursIn" != libsbml.BQB_OCCURS_IN.toString() ) == false );
      assertTrue( (  "hasProperty" != libsbml.BQB_HAS_PROPERTY.toString() ) == false );
      assertTrue( (  "isPropertyOf" != libsbml.BQB_IS_PROPERTY_OF.toString() ) == false );
      assertTrue( (  "hasTaxon" != libsbml.BQB_HAS_TAXON.toString() ) == false );
    ...
    public void test_CVTerm_get_model_qualifiers()
    {
      ...
      assertTrue( (  "is" != libsbml.BQM_IS.toString() ) == false );
      assertTrue( (  "isDescribedBy" != libsbml.BQM_IS_DESCRIBED_BY.toString() ) == false );
      assertTrue( (  "isDerivedFrom" != libsbml.BQM_IS_DERIVED_FROM.toString() ) == false );
    ...
    public void test_CVTerm_set_get()
    {
      ...
      assertTrue( (  "is"  != term.getModelQualifierType().toString() ) == false );
      ...
      assertTrue( term.getQualifierType() == libsbml.BIOLOGICAL_QUALIFIER );
      assertTrue( term.getBiologicalQualifierType() == libsbml.BQB_IS );
      assertTrue( (  "is"  != term.getBiologicalQualifierType().toString() ) == false );
