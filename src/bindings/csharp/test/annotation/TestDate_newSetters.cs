...
namespace LibSBMLCSTest.annotation {
  ...
  public class TestDate_newSetters {
    ...
    public void test_Date_accessWithNULL()
    {
      assertTrue( null.clone() == null );
      assertTrue( new  Date(null) == null );
      assertTrue( null.getDateAsString() == null );
      assertTrue( null.getDay() == SBML_INT_MAX );
      assertTrue( null.getHour() == SBML_INT_MAX );
      assertTrue( null.getHoursOffset() == SBML_INT_MAX );
      assertTrue( null.getMinute() == SBML_INT_MAX );
      assertTrue( null.getMinutesOffset() == SBML_INT_MAX );
      assertTrue( null.getMonth() == SBML_INT_MAX );
      assertTrue( null.getSecond() == SBML_INT_MAX );
      assertTrue( null.getSignOffset() == SBML_INT_MAX );
      assertTrue( null.getYear() == SBML_INT_MAX );
      assertTrue( null.representsValidDate() == 0 );
      assertTrue( null.setDateAsString("") == libsbml.LIBSBML_INVALID_OBJECT );
      assertTrue( null.setDay(0) == libsbml.LIBSBML_INVALID_OBJECT );
      assertTrue( null.setHour(0) == libsbml.LIBSBML_INVALID_OBJECT );
      assertTrue( null.setHoursOffset(0) == libsbml.LIBSBML_INVALID_OBJECT );
      assertTrue( null.setMinute(0) == libsbml.LIBSBML_INVALID_OBJECT );
      assertTrue( null.setMinutesOffset(0) == libsbml.LIBSBML_INVALID_OBJECT );
      assertTrue( null.setMonth(0) == libsbml.LIBSBML_INVALID_OBJECT );
      assertTrue( null.setSecond(0) == libsbml.LIBSBML_INVALID_OBJECT );
      assertTrue( null.setSignOffset(0) == libsbml.LIBSBML_INVALID_OBJECT );
      assertTrue( null.setYear(0) == libsbml.LIBSBML_INVALID_OBJECT );
    }
