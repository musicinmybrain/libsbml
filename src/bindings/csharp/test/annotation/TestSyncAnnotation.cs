...
namespace LibSBMLCSTest.annotation {
  ...
  public class TestSyncAnnotation {
    ...
    "</compartment>";
      sbml = c.toSBML();
      assertEquals( true, equals(expected2,sbml) );
      sbml = null;
      mh = null;
      cv = null;
    }
    ...
    "</compartment>";
      sbml = c.toSBML();
      assertEquals( true, equals(expected3,sbml) );
      sbml = null;
      mh = null;
      cv = null;
    }
    ...
    public void test_SyncAnnotation_nestedCV_invalid()
    {
      Compartment c = new Compartment(2,4);
      c.setMetaId("_000012");
      c.setId("cc");
      c.setConstant(true);
      string annot = "    <rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:dc=\"http://purl.org/dc/elements/1.1/\" xmlns:dcterms=\"http://purl.org/dc/terms/\" xmlns:vCard=\"http://www.w3.org/2001/vcard-rdf/3.0#\" xmlns:bqbiol=\"http://biomodels.net/biology-qualifiers/\" xmlns:bqmodel=\"http://biomodels.net/model-qualifiers/\">\n" + 
    "      <rdf:Description rdf:about=\"#_000012\">\n" + 
    "        <bqbiol:is>\n" + 
    "          <rdf:Bag>\n" + 
    "            <rdf:li rdf:resource=\"http://www.geneontology.org/#GO:0007274\"/>\n" + 
    ...
    public void test_SyncAnnotation_ordering_bug_1()
    {
      ...
      string addedAnn = + "<prA:other xmlns:prA=\"http://some\">This is additional</prA:other>";
    ...
    public void test_SyncAnnotation_ordering_bug_2()
    {
      Compartment c = new Compartment(2,3);
      c.setMetaId("_000003");
      c.setId("A");
