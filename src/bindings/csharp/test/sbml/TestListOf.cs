...
namespace LibSBMLCSTest.sbml {
  ...
  public class TestListOf {
    ...
    public void test_ListOf_sort()
    {
      ...
      assertTrue( child.getId() ==  "a" );
      child = lo.get(1);
      assertTrue( child.getId() ==  "n" );
      child = lo.get(2);
      assertTrue( child.getId() ==  "z" );
      sp = null;
      lo = null;
    }
    ...
    public void test_ListOf_sort_meta()
    {
      ...
      lo.sort();
      SBase child = lo.get(0);
      assertTrue( child.getMetaId() ==  "a" );
      child = lo.get(1);
      assertTrue( child.getMetaId() ==  "n" );
      child = lo.get(2);
      assertTrue( child.getMetaId() ==  "z" );
      sp = null;
      lo = null;
    }
    ...
    public void test_ListOf_sort_rules()
    {
      ...
      lo.sort();
      SBase child = lo.get(0);
      assertTrue( child.getIdAttribute() ==  "" );
      assertTrue( child.getId() ==  "n" );
      child = lo.get(1);
      assertTrue( child.getIdAttribute() ==  "" );
      assertTrue( child.getId() ==  "q" );
      child = lo.get(2);
      assertTrue( child.getIdAttribute() ==  "a" );
      assertTrue( child.getId() ==  "z" );
      child = lo.get(3);
      assertTrue( child.getIdAttribute() ==  "z" );
      assertTrue( child.getId() ==  "a" );
      rr = null;
      lo = null;
    }
