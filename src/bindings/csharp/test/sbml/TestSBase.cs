...
namespace LibSBMLCSTest.sbml {
  ...
  public class TestSBase {
    ...
    public void test_SBase_prefixMetaIdSBO()
    {
      ...
      assertTrue( noPrefix.find(" metaid=") != string::npos );
      assertTrue( noPrefix.find(" sboTerm=") != string::npos );
      ...
      assertTrue( prefix.find(" l3v1:metaid=") != string::npos );
      assertTrue( prefix.find(" l3v1:sboTerm=") != string::npos );
      assertTrue( noPrefix != prefix );
    }
    ...
    "</annotation>";
      ...
      str = S.getAnnotationString();
      assertTrue( S.isSetAnnotation() == true );
      assertTrue(( annt_with_cvterm == str ));
      S.unsetAnnotation();
      assertTrue( S.isSetAnnotation() == false );
      assertTrue( S.getAnnotation() == null );
      cv = null;
    ...
    "</annotation>";
      ...
      assertTrue( S.isSetAnnotation() == true );
      str = S.getAnnotationString();
      assertTrue(( annt_with_modelhistory == str ));
      S.unsetAnnotation();
      assertTrue( S.isSetAnnotation() == false );
      assertTrue( S.getAnnotation() == null );
      dc = null;
