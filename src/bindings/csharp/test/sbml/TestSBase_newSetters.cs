...
namespace LibSBMLCSTest.sbml {
  ...
  private const int SBML_INT_MAX = 2147483647;
    ...
    public void test_SBase_appendAnnotation1()
    {
      ...
      assertTrue((     "This is additional" == t1.getChild(0).getChild(0).getCharacters() ));
      token1 = null;
      node1 = null;
      node_top1 = null;
    ...
    "</annotation>";
      ...
      assertTrue((     "This is a test note" == t1.getChild(0).getChild(0).getCharacters() ));
      assertTrue((     "This is additional" == t1.getChild(1).getChild(0).getCharacters() ));
      assertTrue((     "This is a new annotation" == t1.getChild(2).getChild(0).getCharacters() ));
      triple = null;
      att = null;
      ns = null;
      token_top = null;
    ...
    public void test_SBase_setSBOTerm2()
    {
      ...
      assertTrue( (  "SBO:0000005" != sboid ) == false );
      string str = S.getSBOTermAsURL();
      assertTrue( (                 "http://identifiers.org/biomodels.sbo/SBO:0000005" != str ) == false );
      i = S.unsetSBOTerm();
      assertTrue( i == libsbml.LIBSBML_OPERATION_SUCCESS );
      ...
      assertTrue( (  "SBO:0000000" != sboid ) == false );
      str = S.getSBOTermAsURL();
      assertTrue( (                 "http://identifiers.org/biomodels.sbo/SBO:0000000" != str ) == false );
      i = S.setSBOTerm(9999999);
      assertTrue( i == libsbml.LIBSBML_OPERATION_SUCCESS );
      assertEquals( true, S.isSetSBOTerm() );
      assertTrue( S.getSBOTerm() == 9999999 );
      sboid = S.getSBOTermID();
      assertTrue( (  "SBO:9999999" != sboid ) == false );
      str = S.getSBOTermAsURL();
      assertTrue( (                 "http://identifiers.org/biomodels.sbo/SBO:9999999" != str ) == false );
