...
namespace LibSBMLCSTest.sbml {
  ...
  public class TestUnit {
    ...
    public void test_Unit_merge()
    {
      string old_locale;
      old_locale = safe_strdup;
      Unit u1 = new  Unit(2,3);
      u1.setKind(libsbml.UNIT_KIND_LITRE);
      u1.setExponent(1);
      u1.setScale(-3);
      u1.setMultiplier(1.00);
      Unit u2 = new  Unit(2,3);
      u2.setKind(libsbml.UNIT_KIND_LITRE);
      u2.setExponent(-1);
      u2.setScale(-3);
      u2.setMultiplier(1);
      u1.merge(u2);
      assertTrue( u1.getKind() == libsbml.UNIT_KIND_LITRE );
    ...
    public void test_Unit_set_get_unset()
    {
      Unit u = new  Unit(2,4);
      assertTrue( u.getKind() == libsbml.UNIT_KIND_INVALID );
      assertTrue( u.getExponent() == 1 );
      ...
      assertTrue( u.unsetKind() == libsbml.LIBSBML_OPERATION_SUCCESS );
      assertTrue( u.unsetExponent() == libsbml.LIBSBML_UNEXPECTED_ATTRIBUTE );
      assertTrue( u.unsetScale() == libsbml.LIBSBML_UNEXPECTED_ATTRIBUTE );
      assertTrue( u.unsetMultiplier() == libsbml.LIBSBML_UNEXPECTED_ATTRIBUTE );
      assertTrue( u.getKind() == libsbml.UNIT_KIND_INVALID );
      assertTrue( u.getExponent() == 1 );
      assertEquals( true, u.isSetExponent() );
      assertTrue( u.getScale() == 0 );
    ...
    public void test_Unit_unset()
    {
      ...
      assertTrue( u.getScale() == 4 );
      assertTrue( u.getMultiplier() == 3.2 );
      assertTrue( u.isSetKind() == 1 );
      assertTrue( u.isSetExponent() == 1 );
      assertTrue( u.isSetScale() == 1 );
      assertTrue( u.isSetMultiplier() == 1 );
      assertTrue( u.isSetOffset() == 0 );
      u.unsetKind();
      u.unsetExponent();
      u.unsetScale();
      u.unsetMultiplier();
      assertTrue( u.isSetKind() == 0 );
      assertTrue( u.isSetExponent() == 1 );
      assertTrue( u.isSetScale() == 1 );
      assertTrue( u.isSetMultiplier() == 1 );
      assertTrue( u.isSetOffset() == 0 );
