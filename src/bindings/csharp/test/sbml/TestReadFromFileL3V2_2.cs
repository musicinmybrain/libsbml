///  @file    TestReadFromFileL3V2_2.cs
...
namespace LibSBMLCSTest.sbml {
  ...
  public class TestReadFromFileL3V2_2 {
    ...
    "</sbml>\n";
      ...
      assertTrue( m.getListOfParameters().getId() ==  "d" );
      ...
      assertTrue( m.getListOfInitialAssignments().getName() ==  "55" );
      ...
      assertTrue( m.getListOfConstraints().getId() ==  "c" );
