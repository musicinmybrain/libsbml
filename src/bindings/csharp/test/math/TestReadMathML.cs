...
namespace LibSBMLCSTest.math {
  ...
  public double util_NegInf()
  {
    ...
    "</apply>\n");
      ...
      assertTrue( N.getType() == libsbml.AST_CSYMBOL_FUNCTION );
      assertTrue((  "NA" == N.getName() ));
      assertTrue((  "http://www.other/symbols/foo" == N.getDefinitionURLString() ));
      F = libsbml.formulaToString(N);
      assertTrue((  "NA(y)" == F ));
      xmlns = null;
    ...
    public void test_element_generic_csymbol_1()
    {
      ...
      assertTrue( N != null );
      assertTrue( N.getType() == libsbml.AST_CSYMBOL_FUNCTION );
      assertTrue((  "unknown_function" == N.getName() ));
      assertTrue((  "http://www.sbml.org/sbml/symbols/unknown/URL" == N.getDefinitionURLString() ));
      assertTrue( N.getNumChildren() == 0 );
    }
    ...
    "</apply>\n");
      ...
      assertTrue( N != null );
      F = libsbml.formulaToString(N);
      assertTrue((  "unknown_function(x, y)" == F ));
    }
    ...
    "</apply>\n");
      ...
      assertTrue( N != null );
      F = libsbml.formulaToString(N);
      assertTrue((  "pow(unknown_function(P, Q), q)" == F ));
    }
