...
namespace LibSBMLCSTest.math {
  ...
  public class TestReadFromFile2 {
    ...
    public void test_read_MathML_2()
    {
      ...
      assertTrue((  "lambda(x, piecewise(p, leq(x, 4)))" == math ));
      ...
      assertTrue((  "piecewise(p, leq(x, 4))" == math ));
      ...
      assertTrue((  "piecewise(-x, lt(x, 0), 0, eq(x, 0))" == math ));
