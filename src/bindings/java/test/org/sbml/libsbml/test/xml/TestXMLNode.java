...
public class TestXMLNode {
  ...
  public void test_XMLNode_attribute_add_remove()
  {
    ...
    test = node.getAttrValue( "name1", "http://name1.org/");
    assertTrue( !test.equals( "val1" ) == false );
    test = null;
    test = node.getAttrValue( "name2", "http://name2.org/");
    assertTrue( !test.equals( "val2" ) == false );
    test = null;
    test = node.getAttrValue(xt1);
    assertTrue( !test.equals( "val1" ) == false );
    test = null;
    test = node.getAttrValue(xt2);
    assertTrue( !test.equals( "val2" ) == false );
    test = null;
    ...
    test = node.getAttrName(3);
    assertTrue( !test.equals( "name1") == false );
    test = null;
    test = node.getAttrValue(3);
    assertTrue( !test.equals( "val1a") == false );
    test = null;
    test = node.getAttrURI(3);
    assertTrue( !test.equals( "http://name1a.org/") == false );
    test = null;
    test = node.getAttrPrefix(3);
    assertTrue( !test.equals( "p1a") == false );
    test = null;
    test = node.getAttrName(4);
    assertTrue( !test.equals( "name2") == false );
    test = null;
    test = node.getAttrValue(4);
    assertTrue( !test.equals( "val2a") == false );
    test = null;
    test = node.getAttrURI(4);
    assertTrue( !test.equals( "http://name2a.org/") == false );
    test = null;
    test = node.getAttrPrefix(4);
    assertTrue( !test.equals( "p2a") == false );
    test = null;
    test = node.getAttrValue( "name1", "http://name1a.org/");
    assertTrue( !test.equals( "val1a" ) == false );
    test = null;
    test = node.getAttrValue( "name2", "http://name2a.org/");
    assertTrue( !test.equals( "val2a" ) == false );
    test = null;
    test = node.getAttrValue(xt1a);
    assertTrue( !test.equals( "val1a" ) == false );
    test = null;
    test = node.getAttrValue(xt2a);
    assertTrue( !test.equals( "val2a" ) == false );
    test = null;
  ...
  public void test_XMLNode_attribute_set_clear()
  {
    ...
    assertTrue( !test.equals( "val3") == false );
    test = null;
    test = node.getAttrURI(2);
    assertTrue( !test.equals( "http://name3.org/") == false );
    test = null;
    test = node.getAttrPrefix(2);
  ...
  public void test_XMLNode_convert()
  {
    ...
    test = attr.getName(0);
    assertTrue( !test.equals( "id"   ) == false );
    test = null;
    test = attr.getValue(0);
  ...
  public void test_XMLNode_createElement()
  {
    ...
    test = cattr.getName(0);
    assertTrue( !test.equals( "id"   ) == false );
    test = null;
    test = cattr.getValue(0);
    assertTrue( !test.equals( "value") == false );
    test = null;
    test = cattr.getPrefix(0);
    assertTrue( !test.equals(prefix) == false );
    test = null;
    test = cattr.getURI(0);
    assertTrue( !test.equals(uri) == false );
    test = null;
    triple = null;
    attr = null;
    ns = null;
  ...
  public void test_XMLNode_getChildForName()
  {
    ...
    assertTrue( !annotation.getName().equals("test") == false );
    node = null;
  }
  ...
  public void test_XMLNode_getters()
  {
    ...
    test = returnattr.getName(0);
    assertTrue( !test.equals( "attr2") == false );
    test = null;
    test = returnattr.getValue(0);
    assertTrue( !test.equals( "value") == false );
    test = null;
    triple = null;
    token = null;
  ...
  public void test_XMLNode_hasChild()
  {
    String xmlstr = "<annotation>\n" + "  <test xmlns=\"http://test.org/\" id=\"test\">test</test>\n" + "</annotation>";
    XMLNode node = new XMLNode();
    assertTrue( node.hasChild( "test").equals((int)false) );
    node = null;
    node = XMLNode.convertStringToXMLNode(xmlstr,null);
    assertTrue( node.hasChild( "test").equals((int)true) );
    node = null;
  }
  ...
  public void test_XMLNode_namespace_get()
  {
    ...
    test = node.getNamespacePrefix(1);
    assertTrue( !test.equals( "test2") == false );
    test = null;
    test = node.getNamespacePrefix( "http://test1.org/");
    assertTrue( !test.equals( "test1") == false );
    test = null;
    test = node.getNamespaceURI(1);
    assertTrue( !test.equals( "http://test2.org/") == false );
    test = null;
    test = node.getNamespaceURI( "test2");
    assertTrue( !test.equals( "http://test2.org/") == false );
    test = null;
    assertTrue( node.getNamespaceIndex( "http://test1.org/") == 0 );
