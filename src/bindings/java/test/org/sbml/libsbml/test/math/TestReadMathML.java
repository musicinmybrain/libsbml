...
public class TestReadMathML {
  ...
  public void test_convert_unary_plus()
  {
    String s = wrapMathML("<apply><plus/><cn>1</cn></apply>"  
    );
    N = libsbml.readMathMLFromString(s);
    assertTrue( N != null );
    String result = libsbml.formulaToString(N);
    assertTrue( result != null );
    N = libsbml.parseFormula(result);
    assertTrue( N != null );
  }
  ...
  public void test_element_child_func()
  {
    String s = wrapMathML("<apply>" + 
    "  <cos/>" + 
    "  <apply>" + 
    ...
    assertTrue( N != null );
    F = libsbml.formulaToString(N);
    assertTrue(F.equals( "cos(pow(x, 2))"));
    ASTNode child = N.getChild(0);
    ASTNode c1 = new ASTNode(libsbml.AST_NAME);
    c1.setName("y");
    child.replaceChild(0,c1,true);
    F = libsbml.formulaToString(N);
    assertTrue(F.equals( "cos(pow(y, 2))"));
  }

  public void test_element_child_func1()
  {
    N = new ASTNode(libsbml.AST_FUNCTION_COS);
    ASTNode pow = new ASTNode(libsbml.AST_FUNCTION_POWER);
    ASTNode x = new ASTNode(libsbml.AST_NAME);
    x.setName("x");
    ASTNode two = new ASTNode(libsbml.AST_REAL);
    two.setValue(2.0);
    pow.addChild(x);
    pow.addChild(two);
    N.addChild(pow);
  ...
  public void test_element_cn_class()
  {
    String s = wrapMathML("<cn class=\"test\"> 12345.7 </cn>");
    N = libsbml.readMathMLFromString(s);
    assertTrue( N != null );
    assertTrue( N.getType() == libsbml.AST_REAL );
    assertEquals( true, util_isEqual );
    assertTrue( N.getClass().equals( "test"   ) );
    assertTrue( N.getNumChildren() == 0 );
  }
  ...
  public void test_element_cn_id()
  {
    String s = wrapMathML("<cn id=\"test\"> 12345.7 </cn>");
    N = libsbml.readMathMLFromString(s);
    assertTrue( N != null );
    assertTrue( N.getType() == libsbml.AST_REAL );
    assertEquals( true, util_isEqual );
    assertTrue( N.getId().equals( "test"   ) );
    assertTrue( N.getNumChildren() == 0 );
  }
  ...
  public void test_element_cn_style()
  {
    String s = wrapMathML("<cn style=\"test\"> 12345.7 </cn>");
    N = libsbml.readMathMLFromString(s);
    assertTrue( N != null );
    assertTrue( N.getType() == libsbml.AST_REAL );
    assertEquals( true, util_isEqual );
    assertTrue( N.getStyle().equals( "test"   ) );
    assertTrue( N.getNumChildren() == 0 );
  }
  ...
  public void test_element_csymbol_delay_4()
  {
    String s = wrapMathML("<apply>" + 
    "  <csymbol encoding='text' definitionURL='http://www.sbml.org/sbml/" + 
    "symbols/delay'> my_delay </csymbol>" + 
    ...
    assertTrue( N != null );
    F = libsbml.formulaToString(N);
    assertTrue(F.equals( "my_delay(x)"));
  }

  public void test_element_csymbol_other()
  {
    String s = wrapMathML("<csymbol encoding='text' " + "definitionURL='http://www.other/symbols/foo'> NA </csymbol>");
    N = libsbml.readMathMLFromString(s);
    assertTrue( N != null );
    assertTrue( N.getType() == libsbml.AST_CSYMBOL_FUNCTION );
    assertTrue(N.getName().equals( "NA"));
    assertTrue( N.getNumChildren() == 0 );
  }

  public void test_element_csymbol_other_withNS()
  {
    String s = wrapMathML("<csymbol encoding='text' " + "definitionURL='http://www.other/symbols/foo'> NA </csymbol>");
  ...
  public void test_element_csymbol_other_withNS_1()
  {
    String s = wrapMathML("<apply>""<csymbol encoding='text' " + 
    "definitionURL='http://www.other/symbols/foo'> NA </csymbol>" + 
    "  <ci> y </ci>" + 
    "</apply>\n");
    XMLNamespaces xmlns = new XMLNamespaces();
    xmlns.add("any_uri");
    DefinitionURLRegistry.getInstance().addDefinitionURL("http://www.other/symbols/foo",libsbml.AST_CSYMBOL_FUNCTION);
    N = readMathMLFromStringWithNamespaces;
    assertTrue( N != null );
    assertTrue( N.getType() == libsbml.AST_CSYMBOL_FUNCTION );
    assertTrue(N.getName().equals( "NA"));
    assertTrue(N.getDefinitionURLString().equals( "http://www.other/symbols/foo"));
    F = libsbml.formulaToString(N);
    assertTrue(F.equals( "NA(y)"));
    xmlns = null;
    DefinitionURLRegistry.getInstance().clearDefinitions();
  }

  public void test_element_csymbol_rateof_1()
  {
    String s = wrapMathML("<csymbol encoding='text' " + "definitionURL='http://www.sbml.org/sbml/symbols/rateOf'> rateOf </csymbol>");
    N = libsbml.readMathMLFromString(s);
    assertTrue( N != null );
    assertTrue( N.getType() == libsbml.AST_FUNCTION_RATE_OF );
    assertTrue(N.getName().equals( "rateOf"));
    assertTrue( N.getNumChildren() == 0 );
  }

  public void test_element_csymbol_rateof_2()
  {
    String s = wrapMathML("<apply>" + 
    "  <csymbol encoding='text' definitionURL='http://www.sbml.org/sbml/" + 
    ...
    assertTrue( N != null );
    F = libsbml.formulaToString(N);
    assertTrue(F.equals( "my_rateof(x)"));
  }

  public void test_element_csymbol_rateof_3()
  {
    String s = wrapMathML("<apply>" + 
    "  <power/>" + 
    "  <apply>" + 
    ...
    assertTrue( N != null );
    F = libsbml.formulaToString(N);
    assertTrue(F.equals( "pow(rateof(P), q)"));
  }

  public void test_element_csymbol_rateof_4()
  {
    String s = wrapMathML("<apply>" + 
    "  <csymbol encoding='text' definitionURL='http://www.sbml.org/sbml/" + 
    "symbols/rateOf'> my_rateof </csymbol>" + 
  ...
  public void test_element_generic_csymbol_1()
  {
    String s = wrapMathML("<csymbol encoding='text' " + "definitionURL='http://www.sbml.org/sbml/symbols/unknown/URL'> unknown_function </csymbol>");
    N = libsbml.readMathMLFromString(s);
    assertTrue( N != null );
    assertTrue( N.getType() == libsbml.AST_CSYMBOL_FUNCTION );
    assertTrue(N.getName().equals( "unknown_function"));
    assertTrue(N.getDefinitionURLString().equals( "http://www.sbml.org/sbml/symbols/unknown/URL"));
    assertTrue( N.getNumChildren() == 0 );
  }

  public void test_element_generic_csymbol_2()
  {
    String s = wrapMathML("<apply>" + 
    "<csymbol encoding='text' " + 
    ...
    assertTrue( N != null );
    F = libsbml.formulaToString(N);
    assertTrue(F.equals( "unknown_function(x, y)"));
  }

  public void test_element_generic_csymbol_3()
  {
    String s = wrapMathML("<apply>" + 
    "  <power/>" + 
    "  <apply>" + 
    ...
    assertTrue( N != null );
    F = libsbml.formulaToString(N);
    assertTrue(F.equals( "pow(unknown_function(P, Q), q)"));
  }
  ...
  public void test_element_implies()
  {
    String s = wrapMathML("<apply> <implies/> <ci>a</ci> <ci>b</ci> </apply>"  
    );
    N = libsbml.readMathMLFromString(s);
    assertTrue( N != null );
    F = libsbml.formulaToString(N);
    assertTrue(F.equals( "implies(a, b)"));
  }
  ...
  public void test_element_max()
  {
    String s = wrapMathML("<apply> <max/> <ci>a</ci> <ci>b</ci> </apply>"  
    );
    N = libsbml.readMathMLFromString(s);
    assertTrue( N != null );
    F = libsbml.formulaToString(N);
    assertTrue(F.equals( "max(a, b)"));
  }

  public void test_element_min()
  {
    String s = wrapMathML("<apply> <min/> <ci>a</ci> <ci>b</ci> </apply>"  
    );
    N = libsbml.readMathMLFromString(s);
    assertTrue( N != null );
    F = libsbml.formulaToString(N);
    assertTrue(F.equals( "min(a, b)"));
  }
  ...
  public void test_element_piecewise_no_args_1()
  {
    String s = wrapMathML("<piecewise>" + "</piecewise>");
    N = libsbml.readMathMLFromString(s);
    assertTrue( N != null );
    F = libsbml.formulaToString(N);
    assertTrue(F.equals( "piecewise()"));
  }

  public void test_element_piecewise_no_args_2()
  {
    String s = wrapMathML("<piecewise/>"  
    );
    N = libsbml.readMathMLFromString(s);
  ...
  public void test_element_piecewise_one_arg()
  {
    String s = wrapMathML("<piecewise>" + 
    "  <otherwise>" + 
    "    <ci>x</ci>" + 
    ...
    assertTrue( N != null );
    F = libsbml.formulaToString(N);
    assertTrue(F.equals( "piecewise(x)"));
  }
  ...
  public void test_element_quotient()
  {
    String s = wrapMathML("<apply> <quotient/> <ci>a</ci> <ci>b</ci> </apply>"  
    );
    N = libsbml.readMathMLFromString(s);
    assertTrue( N != null );
    F = libsbml.formulaToString(N);
    assertTrue(F.equals( "quotient(a, b)"));
  }

  public void test_element_rem()
  {
    String s = wrapMathML("<apply> <rem/> <ci>a</ci> <ci>b</ci> </apply>"  
    );
    N = libsbml.readMathMLFromString(s);
    assertTrue( N != null );
    F = libsbml.formulaToString(N);
    assertTrue(F.equals( "rem(a, b)"));
  }
