...
public class TestReadFromFile2 {
  ...
  public void test_read_MathML_2()
  {
    ...
    assertTrue(math.equals( "lambda(x, piecewise(p, leq(x, 4)))"));
    ...
    assertTrue(math.equals( "piecewise(p, leq(x, 4))"));
    ...
    assertTrue(math.equals( "leq(x, 4)"));
    ...
    assertTrue(math.equals( "piecewise(-x, lt(x, 0), 0, eq(x, 0))"));
    ...
    assertTrue(math.equals( "log(3, x)"));
