...
public class TestModelHistory {
  ...
  public void test_ModelHistory_accessWithNULL()
  {
    assertTrue( null.addCreator(null) == libsbml.LIBSBML_INVALID_OBJECT );
    assertTrue( null.addModifiedDate(null) == libsbml.LIBSBML_INVALID_OBJECT );
    assertTrue( null.clone() == null );
    assertTrue( null.getCreatedDate() == null );
    assertTrue( null.getCreator(0) == null );
    assertTrue( null.getListCreators() == null );
    assertTrue( null.getListModifiedDates() == null );
    assertTrue( null.getModifiedDate() == null );
    assertTrue( null.getModifiedDate(0) == null );
    assertTrue( null.getNumCreators() == SBML_INT_MAX );
    assertTrue( null.getNumModifiedDates() == SBML_INT_MAX );
    assertTrue( null.hasRequiredAttributes() == 0 );
    assertTrue( null.isSetCreatedDate() == false );
    assertTrue( null.isSetModifiedDate() == false );
    assertTrue( null.setCreatedDate(null) == libsbml.LIBSBML_INVALID_OBJECT );
    assertTrue( null.setModifiedDate(null) == libsbml.LIBSBML_INVALID_OBJECT );
  }
