/*
 * @file    TestReadFromFileL2V5.java
...
public class TestReadFromFileL2V5 {
  ...
  public void test_echo_l2v5_all()
  {
  ...
  public void test_read_l2v5_all()
  {
    ...
    assertTrue( d.getVersion() == 5 );
    m = d.getModel();
    assertTrue( m != null );
    assertTrue( m.getId().equals( "l2v5_all") );
    ...
    ast = kl.getMath();
    formula = libsbml.formulaToString(ast);
    assertTrue(formula.equals( "s * k / p"));
