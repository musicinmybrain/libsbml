/*
 * @file    TestRDFAnnotationVCard4.java
...
public class TestRDFAnnotationVCard4 {
  ...
  public void test_RDFAnnotationV4_getModelHistory()
  {
    ...
    assertTrue(mc1.getFamilyName().equals( "Sarah Keating"));
    assertTrue(mc1.getName().equals( "Sarah Keating"));
    assertTrue(mc1.getGivenName().equals( "Sarah Keating"));
