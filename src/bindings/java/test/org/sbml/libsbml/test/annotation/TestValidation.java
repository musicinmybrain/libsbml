...
public class TestValidation {
  ...
  public void test_Validation_Date_Default()
  {
    Date date1 = new Date();
    Date date2 = new Date("");
    assertTrue( date1.getYear().equals(date2.getYear()) );
    assertTrue( date1.getMonth().equals(date2.getMonth()) );
    assertTrue( date1.getDay().equals(date2.getDay()) );
    assertTrue( date1.getHour().equals(date2.getHour()) );
    assertTrue( date1.getMinute().equals(date2.getMinute()) );
    assertTrue( date1.getSecond().equals(date2.getSecond()) );
    assertTrue( date1.getSignOffset().equals(date2.getSignOffset()) );
    assertTrue( date1.getHoursOffset().equals(date2.getHoursOffset()) );
    assertTrue( date1.getMinutesOffset().equals(date2.getMinutesOffset()) );
    date1 = null;
    date2 = null;
  }
