...
public class TestCopyAndClone {
  ...
  public void test_CVTerm_ConstructorException()
  {
    String msg;
    try {CVTerm * cvterm = new CVTerm(libsbml.BIOLOGICAL_QUALIFIER);
  }
...
assertTrue( msg.equals( "") );
  ...
  public void test_Date_ConstructorException()
  {
    String msg;
    try {Date * date = new Date(2005,12,30,12,15,45,1,2,0);
  }
  catch (SBMLConstructorException &e){msg = e.what();
}
assertTrue( msg.equals( "") );
  ...
  public void test_ModelCreator_ConstructorException()
  {
    String msg;
    try {ModelCreator * mc = new ModelCreator();
  }
  catch (SBMLConstructorException &e){msg = e.what();
}
assertTrue( msg.equals( "") );
  ...
  public void test_ModelHistory_ConstructorException()
  {
    String msg;
    try {ModelHistory * mh = new ModelHistory();
  }
  catch (SBMLConstructorException &e){msg = e.what();
}
assertTrue( msg.equals( "") );
  ...
  public void test_NestedCVTerm_assignmentOperator()
  {
    CVTerm CVTerm1 = new CVTerm(libsbml.BIOLOGICAL_QUALIFIER);
    CVTerm1.setBiologicalQualifierType(libsbml.BQB_IS);
    CVTerm1.addResource("http://www.geneontology.org/#GO:0005892");
    CVTerm CVTermN = new CVTerm(libsbml.BIOLOGICAL_QUALIFIER);
    CVTermN.setBiologicalQualifierType(libsbml.BQB_IS);
    CVTermN.addResource("nested resource");
    assertTrue( CVTermN.getQualifierType() == libsbml.BIOLOGICAL_QUALIFIER );
    assertTrue( CVTermN.getResources().getLength() == 1 );
    assertTrue( CVTermN.getResources().getValue(0).equals( "nested resource") );
    CVTerm1.addNestedCVTerm(CVTermN);
    assertTrue( CVTerm1.getNumNestedCVTerms() == 1 );
    assertTrue( CVTerm1.getNestedCVTerm(0).getQualifierType() == libsbml.BIOLOGICAL_QUALIFIER );
    assertTrue( CVTerm1.getNestedCVTerm(0).getResources().getLength() == 1 );
    assertTrue( CVTerm1.getNestedCVTerm(0).getResources().getValue(0).equals( "nested resource") );
    CVTerm CVTerm2 = new CVTerm();
    CVTerm2 = CVTerm1;
    assertTrue( CVTerm2.getQualifierType() == libsbml.BIOLOGICAL_QUALIFIER );
    assertTrue( CVTerm2.getResources().getLength() == 1 );
    assertTrue( CVTerm2.getResources().getValue(0).equals( "http://www.geneontology.org/#GO:0005892") );
    assertTrue( CVTerm2.getNumNestedCVTerms() == 1 );
    assertTrue( CVTerm2.getNestedCVTerm(0).getQualifierType() == libsbml.BIOLOGICAL_QUALIFIER );
    assertTrue( CVTerm2.getNestedCVTerm(0).getResources().getLength() == 1 );
    assertTrue( CVTerm2.getNestedCVTerm(0).getResources().getValue(0).equals( "nested resource") );
    CVTerm2 = null;
    CVTerm1 = null;
    CVTermN = null;
  }

  public void test_NestedCVTerm_clone()
  {
    CVTerm CVTerm1 = new CVTerm(libsbml.BIOLOGICAL_QUALIFIER);
    CVTerm1.setBiologicalQualifierType(libsbml.BQB_IS);
    CVTerm1.addResource("http://www.geneontology.org/#GO:0005892");
  ...
  public void test_NestedCVTerm_copyConstructor()
  {
    CVTerm CVTerm1 = new CVTerm(libsbml.BIOLOGICAL_QUALIFIER);
    CVTerm1.setBiologicalQualifierType(libsbml.BQB_IS);
    CVTerm1.addResource("http://www.geneontology.org/#GO:0005892");
