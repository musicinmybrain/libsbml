...
public class TestASTNode {
  ...
  public void test_ASTNode_accessWithNULL()
  {
    ...
    assertTrue( null.getUnits().equals("") == true );
  ...
  public void test_ASTNode_class()
  {
    ...
    assertTrue(nclass.equals( "test"));
    i = n.unsetClass();
    assertTrue( i == libsbml.LIBSBML_OPERATION_SUCCESS );
    assertTrue( n.isSetClass() == 0 );
    nclass = n.getClass();
    assertTrue(nclass.equals( ""));
    n = null;
  }
  ...
  public void test_ASTNode_deepCopy_2()
  {
    ...
    assertTrue(copy.getName().equals(node.getName()));
    node = null;
    copy = null;
  }
  ...
  public void test_ASTNode_insertChild()
  {
    ...
    assertTrue( node.getNumChildren() == 3 );
    String math = libsbml.formulaToString(node);
    assertTrue(math.equals( "and(a, b, c)"));
    newc.setName( "d");
    newc1.setName( "e");
    ...
    math = libsbml.formulaToString(node);
    assertTrue(math.equals( "and(a, d, b, c)"));
    ...
    math = libsbml.formulaToString(node);
    assertTrue(math.equals( "and(a, d, e, b, c)"));
    node = null;
  }
  ...
  public void test_ASTNode_prependChild1()
  {
    ...
    assertTrue( node.getNumChildren() == 3 );
    math = libsbml.formulaToString(node);
    assertTrue(math.equals( "and(d, a, b)"));
  ...
  public void test_ASTNode_replaceArgument1()
  {
    ...
    assertTrue(math.equals( "f(x, y)"));
    node.replaceArgument(bvar,user);
    math = libsbml.formulaToString(node);
    assertTrue(math.equals( "f(x, y) * y"));
    node = null;
    user = null;
  }
  ...
  public void test_ASTNode_replaceArgument3()
  {
    ...
    String math = libsbml.formulaToString(node);
    assertTrue(math.equals( "piecewise(2, gt(2, y), 2)"));
    node.replaceArgument( "y",repl1);
    math = libsbml.formulaToString(node);
    assertTrue(math.equals( "piecewise(2, gt(2, a / b), 2)"));
    node = null;
    repl1 = null;
    repl2 = null;
  }
  ...
  public void test_ASTNode_replaceArgument4()
  {
    ...
    node.replaceArgument(bvar,repl2);
    String math = libsbml.formulaToString(node);
    assertTrue(math.equals( "piecewise(2, gt(2, y), y)"));
    node.replaceArgument( "y",repl1);
    math = libsbml.formulaToString(node);
    assertTrue(math.equals( "piecewise(2, gt(2, a / b), a / b)"));
    node = null;
    repl1 = null;
    repl2 = null;
  }
  ...
  public void test_ASTNode_replaceArgument5()
  {
    ...
    node.replaceArgument(bvar,repl2);
    String math = libsbml.formulaToString(node);
    assertTrue(math.equals( "piecewise(y, gt(2, y), 2)"));
    node.replaceArgument( "y",repl1);
    math = libsbml.formulaToString(node);
    assertTrue(math.equals( "piecewise(a / b, gt(2, a / b), 2)"));
    node = null;
    repl1 = null;
    repl2 = null;
  }
  ...
  public void test_ASTNode_replaceChild()
  {
    ...
    assertTrue( node.getNumChildren() == 3 );
    math = libsbml.formulaToString(node);
    assertTrue(math.equals( "and(d, b, c)"));
    ...
    assertTrue( node.getNumChildren() == 3 );
    math = libsbml.formulaToString(node);
    assertTrue(math.equals( "and(d, e, c)"));
    node = null;
    c1 = null;
    c2 = null;
  }
  ...
  public void test_ASTNode_setName_2()
  {
    ...
    assertTrue( !id.equals( "s") == false );
    assertTrue( !node.getName().equals(name) == false );
    node = null;
  }
  ...
  public void test_ASTNode_setType_10()
  {
    ...
    String units = node.getUnits();
    assertTrue( !id.equals( "s") == false );
    assertTrue( !units.equals( "mole") == false );
    assertTrue( node.getParentSBMLObject().equals((m)) );
    node.setType(libsbml.AST_PLUS);
    assertTrue( node.getType() == libsbml.AST_PLUS );
    assertTrue( node.getInteger() == 0 );
    assertTrue( node.getMantissa() == 0 );
  ...
  public void test_ASTNode_setType_13()
  {
    ...
    assertTrue( !node.getName().equals( "t") == false );
    String url = node.getDefinitionURLString();
    assertTrue( !url.equals( "my_url") == false );
    node.setType(libsbml.AST_FUNCTION);
    assertTrue( node.getType() == libsbml.AST_FUNCTION );
    id = node.getId();
    assertTrue( !id.equals( "s") == false );
  ...
  public void test_ASTNode_setType_14()
  {
    ...
    assertTrue( node.getReal() == 0 );
    String url = node.getDefinitionURLString();
    assertTrue( !url.equals(                       "http://www.sbml.org/sbml/symbols/time") == false );
  ...
  public void test_ASTNode_setType_16()
  {
    ...
    assertTrue( node.getReal() == 0 );
    url = node.getDefinitionURLString();
    assertTrue( !url.equals(                       "http://www.sbml.org/sbml/symbols/delay") == false );
    node = null;
    m = null;
  }
  ...
  public void test_ASTNode_setType_24()
  {
    ...
    assertTrue( !units.equals( "") == false );
    assertTrue( node.getParentSBMLObject().equals((m)) );
    assertTrue( !node.getName().equals( "avogadro") == false );
    assertTrue( node.isName() == 1 );
    url = node.getDefinitionURLString();
    assertTrue( !url.equals(     "http://www.sbml.org/sbml/symbols/avogadro") == false );
    assertTrue( node.isConstant() == 1 );
    node = null;
    m = null;
  }
  ...
  public void test_ASTNode_setType_26()
  {
    ...
    assertTrue( !units.equals( "") == false );
    assertTrue( node.getParentSBMLObject().equals((m)) );
    assertTrue( !node.getName().equals( "delay") == false );
    assertTrue( node.isName() == 0 );
    String url = node.getDefinitionURLString();
    assertTrue( !url.equals(     "http://www.sbml.org/sbml/symbols/delay") == false );
    node.setType(libsbml.AST_NAME_TIME);
  ...
  public void test_ASTNode_setType_27()
  {
    ...
    assertTrue( child.getNumChildren() == 0 );
    id = child.getId();
    assertTrue( !id.equals( "c1") == false );
    assertTrue( child.getParentSBMLObject() == null );
    assertTrue( !child.getName().equals( "child") == false );
    child = node.getChild(1);
    assertTrue( child.getType() == libsbml.AST_REAL );
    assertTrue( child.getNumChildren() == 0 );
    id = child.getId();
    assertTrue( !id.equals( "") == false );
    assertTrue( child.getParentSBMLObject().equals((m)) );
    assertEquals( true, util_isEqual );
    node.setType(libsbml.AST_FUNCTION_COS);
    assertTrue( node.getType() == libsbml.AST_FUNCTION_COS );
    assertTrue( node.getNumChildren() == 2 );
  ...
  public void test_ASTNode_setType_34()
  {
    ...
    assertTrue( !id.equals( "s") == false );
    assertTrue( node.getParentSBMLObject().equals((m)) );
    assertTrue( !node.getName().equals( "my_func") == false );
    String url = node.getDefinitionURLString();
    assertTrue( !url.equals(     "my_url") == false );
    ASTNode child = node.getChild(0);
    assertTrue( child.getType() == libsbml.AST_NAME );
  ...
  public void test_ASTNode_style()
  {
    ...
    assertTrue(style.equals( "test"));
    i = n.unsetStyle();
    assertTrue( i == libsbml.LIBSBML_OPERATION_SUCCESS );
    assertTrue( n.isSetStyle() == 0 );
    style = n.getStyle();
    assertTrue(style.equals( ""));
    n = null;
  }
  ...
  public void test_ASTNode_swapChildren()
  {
    ...
    assertTrue(math.equals( "and(d, f)"));
  ...
  public void test_ASTNode_units()
  {
    ...
    assertTrue(units.equals( "mole"));
    i = n.unsetUnits();
    assertTrue( i == libsbml.LIBSBML_OPERATION_SUCCESS );
    assertTrue( n.isSetUnits() == false );
    units = n.getUnits();
    assertTrue(units.equals( ""));
    i = n.setUnits( "1mole");
  ...
  public void test_ASTNode_userData_1()
  {
    ...
    assertTrue( i == libsbml.LIBSBML_OPERATION_SUCCESS );
    assertTrue( n.getUserData() != null );
    assertTrue( n.getUserData().equals(m) );
