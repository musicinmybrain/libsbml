...
# src/sbml/test/TestReadFromFileL2V5.cpp
...
class TestReadFromFileL2V5(unittest.TestCase):


  def test_echo_l2v5_all(self):
  ...
  def test_read_l2v5_all(self):
    ...
    self.assertTrue( d.getVersion() == 5 )
    m = d.getModel()
    self.assertTrue( m != None )
    self.assertTrue( m.getId() ==  "l2v5_all" )
...
def suite():
  ...
  suite.addTest(unittest.makeSuite(TestReadFromFileL2V5))
