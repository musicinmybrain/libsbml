...
class TestEvent(unittest.TestCase):
  ...
  def test_Event_full(self):
    ...
    _dummyList = [ trigger ]; _dummyList[:] = []; del _dummyList
  ...
  def test_Event_setDelay(self):
    ...
    if (self.E.getDelay() != None):
      pass    
    _dummyList = [ math1 ]; _dummyList[:] = []; del _dummyList
    _dummyList = [ Delay ]; _dummyList[:] = []; del _dummyList
    pass  
  ...
  def test_Event_setUseValuesFromTriggerTime(self):
    ...
    self.assertTrue( object.isSetUseValuesFromTriggerTime() == True )
  ...
  def test_Event_unsetUseValuesFromTriggerTime(self):
    object = libsbml.Event(2,4)
    self.assertTrue( object.getUseValuesFromTriggerTime() == True )
    self.assertTrue( object.isSetUseValuesFromTriggerTime() == True )
    object.setUseValuesFromTriggerTime(True)
