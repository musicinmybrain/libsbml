...
class TestModel(unittest.TestCase):
  ...
  def test_KineticLaw_getParameterById(self):
    ...
    _dummyList = [ k3 ]; _dummyList[:] = []; del _dummyList
    _dummyList = [ k4 ]; _dummyList[:] = []; del _dummyList
    pass  
  ...
  def test_Model_addRules(self):
    ...
    _dummyList = [ r1 ]; _dummyList[:] = []; del _dummyList
    _dummyList = [ r2 ]; _dummyList[:] = []; del _dummyList
    _dummyList = [ r3 ]; _dummyList[:] = []; del _dummyList
    pass  
  ...
  def test_Model_add_get_Event(self):
    ...
    _dummyList = [ e2 ]; _dummyList[:] = []; del _dummyList
  ...
  def test_Model_add_get_FunctionDefinitions(self):
    ...
    _dummyList = [ fd2 ]; _dummyList[:] = []; del _dummyList
    pass  
  ...
  def test_Model_add_get_UnitDefinitions(self):
    ...
    _dummyList = [ ud2 ]; _dummyList[:] = []; del _dummyList
    pass  
  ...
  def test_Model_getNumSpeciesWithBoundaryCondition(self):
    ...
    _dummyList = [ s2 ]; _dummyList[:] = []; del _dummyList
    _dummyList = [ s3 ]; _dummyList[:] = []; del _dummyList
    pass  
  ...
  def test_Model_getParameter(self):
    ...
    _dummyList = [ p2 ]; _dummyList[:] = []; del _dummyList
  ...
  def test_Model_getRules(self):
    ...
    _dummyList = [ scr ]; _dummyList[:] = []; del _dummyList
    _dummyList = [ cvr ]; _dummyList[:] = []; del _dummyList
    _dummyList = [ pr ]; _dummyList[:] = []; del _dummyList
    ar = self.M.getRule(0)
