...
class TestReaction(unittest.TestCase):
  ...
  def test_Reaction_addModifierBySpecies(self):
    s = libsbml.Species(2,4)
    s.setId( "s")
    self.R.addModifier(s, "sr")
    self.assertTrue( self.R.getNumReactants() == 0 )
    self.assertTrue( self.R.getNumProducts() == 0 )
    self.assertTrue( self.R.getNumModifiers() == 1 )
    sr = self.R.getModifier(0)
    self.assertTrue((  "s" == sr.getSpecies() ))
    self.assertTrue((  "sr" == sr.getId() ))
    self.assertTrue( self.R.addModifier(s, "sr") == libsbml.LIBSBML_DUPLICATE_OBJECT_ID )
    self.assertTrue( self.R.getNumModifiers() == 1 )
  ...
  def test_Reaction_addProductBySpecies(self):
    s = libsbml.Species(2,4)
    s.setId( "s")
    self.R.addProduct(s,2.0, "sr",0)
    self.assertTrue( self.R.getNumReactants() == 0 )
    self.assertTrue( self.R.getNumProducts() == 1 )
    self.assertTrue( self.R.getNumModifiers() == 0 )
    sr = self.R.getProduct(0)
    self.assertTrue((  "s" == sr.getSpecies() ))
    self.assertTrue( util_isEqual == 1 )
    self.assertTrue((  "sr" == sr.getId() ))
    self.assertTrue( sr.getConstant() == False )
    self.assertTrue( self.R.addProduct(s,1.0, "sr",0) == libsbml.LIBSBML_DUPLICATE_OBJECT_ID )
    self.assertTrue( self.R.getNumProducts() == 1 )
    _dummyList = [ s ]; _dummyList[:] = []; del _dummyList
    pass  
  ...
  def test_Reaction_addReactantBySpecies(self):
    s = libsbml.Species(2,4)
    s.setId( "s")
    self.R.addReactant(s,2.0, "sr",0)
    self.assertTrue( self.R.getNumReactants() == 1 )
    self.assertTrue( self.R.getNumProducts() == 0 )
    self.assertTrue( self.R.getNumModifiers() == 0 )
    sr = self.R.getReactant(0)
    self.assertTrue((  "s" == sr.getSpecies() ))
    self.assertTrue( util_isEqual == 1 )
    self.assertTrue((  "sr" == sr.getId() ))
    self.assertTrue( sr.getConstant() == False )
    self.assertTrue( self.R.addReactant(s,1.0, "sr",0) == libsbml.LIBSBML_DUPLICATE_OBJECT_ID )
    _dummyList = [ s ]; _dummyList[:] = []; del _dummyList
    pass  

  def test_Reaction_compartment(self):
    name =  "Cell";
    r = libsbml.Reaction(3,1)
    r.setCompartment(name)
    self.assertTrue(( name == r.getCompartment() ))
