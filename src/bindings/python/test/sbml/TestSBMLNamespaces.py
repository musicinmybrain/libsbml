...
class TestSBMLNamespaces(unittest.TestCase):
  ...
  def test_SBMLNamespaces_L1V1(self):
    ...
    self.assertTrue( sbml.isValidCombination() == True )
  ...
  def test_SBMLNamespaces_invalid(self):
    sbml = libsbml.SBMLNamespaces(3,3)
    self.assertTrue( sbml.getLevel() == SBML_INT_MAX )
    self.assertTrue( sbml.getVersion() == SBML_INT_MAX )
    ns = sbml.getNamespaces()
    self.assertTrue( ns == None )
    self.assertTrue( sbml.isValidCombination() == False )
    sbml = None
    pass  
