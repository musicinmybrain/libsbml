...
class TestL3SpeciesReference(unittest.TestCase):
  ...
  def test_L3_SpeciesReference_NS(self):
    ...
    uri = self.SR.getNamespaces().getURI(0)
  ...
  def test_L3_SpeciesReference_denominator(self):
    self.assertTrue( self.SR.setDenominator(2) == libsbml.LIBSBML_UNEXPECTED_ATTRIBUTE )
