...
class TestCopyAndClone(unittest.TestCase):
  ...
  def test_Compartment_assignmentOperator_L3(self):
    o1 = libsbml.Compartment(3,1)
    o1.setId("c")
    o1.setSpatialDimensions(2.5)
    o1.setSize(2)
    self.assertTrue( o1.getId() ==  "c" )
    self.assertTrue( o1.getSpatialDimensionsAsDouble() == 2.5 )
    self.assertTrue( o1.isSetSpatialDimensions() == True )
    self.assertTrue( o1.getConstant() == True )
    self.assertTrue( o1.isSetConstant() == False )
    o2 = libsbml.Compartment(3,1)
    o2 = o1
    self.assertTrue( o2.getId() ==  "c" )
    self.assertTrue( o2.getSpatialDimensionsAsDouble() == 2.5 )
    self.assertTrue( o2.isSetSpatialDimensions() == True )
    self.assertTrue( o2.getConstant() == True )
    self.assertTrue( o2.isSetConstant() == False )
    self.assertTrue( o2.getParentSBMLObject() == o1.getParentSBMLObject() )
    o2 = None
    o1 = None
    pass  
  ...
  def test_Compartment_copyConstructor_L3(self):
    o1 = libsbml.Compartment(3,1)
    o1.setId("c")
    o1.setSpatialDimensions(2.5)
    o1.setSize(2)
  ...
  def test_Event_assignmentOperator_L3(self):
    o1 = libsbml.Event(3,1)
    o1.setId("c")
    o1.setUseValuesFromTriggerTime(False)
    self.assertTrue( o1.getId() ==  "c" )
    self.assertTrue( o1.getUseValuesFromTriggerTime() == False )
    self.assertTrue( o1.isSetUseValuesFromTriggerTime() == True )
    o2 = libsbml.Event(2,4)
    o2 = o1
    self.assertTrue( o2.getId() ==  "c" )
    self.assertTrue( o2.getUseValuesFromTriggerTime() == False )
    self.assertTrue( o2.isSetUseValuesFromTriggerTime() == True )
    self.assertTrue( o2.getParentSBMLObject() == o1.getParentSBMLObject() )
    o2 = None
    o1 = None
    pass  
  ...
  def test_Event_copyConstructor_L3(self):
    o1 = libsbml.Event(3,1)
    o1.setId("c")
    self.assertTrue( o1.getId() ==  "c" )
    self.assertTrue( o1.getUseValuesFromTriggerTime() == True )
    self.assertTrue( o1.isSetUseValuesFromTriggerTime() == False )
    o2 = libsbml.Event(o1)
    self.assertTrue( o2.getId() ==  "c" )
    self.assertTrue( o2.getUseValuesFromTriggerTime() == True )
    self.assertTrue( o2.isSetUseValuesFromTriggerTime() == False )
    self.assertTrue( o2.getParentSBMLObject() == o1.getParentSBMLObject() )
    o2 = None
    o1 = None
    pass  
