...
class TestSpeciesReference(unittest.TestCase):
  ...
  def test_SpeciesReference_setStoichiometryMath(self):
    ...
    _dummyList = [ stoich ]; _dummyList[:] = []; del _dummyList
    pass  

  def test_SpeciesReference_setUnsetStoichiometry(self):
    self.assertEqual( False, self.SR.isSetStoichiometry() )
    self.SR.setStoichiometry(2)
    self.assertTrue( self.SR.getStoichiometry() == 2 )
    self.assertEqual( True, self.SR.isSetStoichiometry() )
    self.assertTrue( self.SR.unsetStoichiometry() == libsbml.LIBSBML_OPERATION_SUCCESS )
    self.assertEqual( True, self.SR.isSetStoichiometry() )
    self.assertTrue( self.SR.getStoichiometry() == 1 )
    pass  

  def test_SpeciesReference_unsetSpecies(self):
    species =  "X0";
    self.SR.setSpecies(species)
    self.assertTrue(( species == self.SR.getSpecies() ))
    self.assertEqual( True, self.SR.isSetSpecies() )
