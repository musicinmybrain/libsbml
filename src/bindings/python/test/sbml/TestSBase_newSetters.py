...
class TestSBase_newSetters(unittest.TestCase):
  ...
  def test_SBase_appendAnnotation(self):
    ...
    i = self.S.appendAnnotation(None)
    self.assertTrue( i == libsbml.LIBSBML_OPERATION_SUCCESS )
    t1 = self.S.getAnnotation()
    self.assertTrue( t1.getNumChildren() == 2 )
    self.assertTrue((     "This is a test note" == t1.getChild(0).getChild(0).getCharacters() ))
    ...
    _dummyList = [ token_top ]; _dummyList[:] = []; del _dummyList
    _dummyList = [ node_top ]; _dummyList[:] = []; del _dummyList
    _dummyList = [ token_top1 ]; _dummyList[:] = []; del _dummyList
    _dummyList = [ node_top1 ]; _dummyList[:] = []; del _dummyList
    _dummyList = [ triple1 ]; _dummyList[:] = []; del _dummyList
    _dummyList = [ ns1 ]; _dummyList[:] = []; del _dummyList
  ...
  def test_SBase_appendAnnotation1(self):
    triple = libsbml.XMLTriple("any", "", "pr")
    att = libsbml.XMLAttributes()
    ns = libsbml.XMLNamespaces()
    ns.add( "http://www.any", "pr")
    ...
    self.assertTrue((     "This is additional" == t1.getChild(0).getChild(0).getCharacters() ))
    _dummyList = [ token1 ]; _dummyList[:] = []; del _dummyList
    _dummyList = [ node1 ]; _dummyList[:] = []; del _dummyList
    _dummyList = [ node_top1 ]; _dummyList[:] = []; del _dummyList
    token1 = libsbml.XMLToken("This is a repeat")
    node1 = libsbml.XMLNode(token1)
    node_top1 = libsbml.XMLNode(token_top1)
    node_top1.addChild(node1)
    i = self.S.appendAnnotation(node_top1)
    self.assertTrue( i == libsbml.LIBSBML_DUPLICATE_ANNOTATION_NS )
    t1 = self.S.getAnnotation()
    self.assertTrue( t1.getNumChildren() == 1 )
    self.assertTrue((     "This is additional" == t1.getChild(0).getChild(0).getCharacters() ))
    _dummyList = [ triple ]; _dummyList[:] = []; del _dummyList
  ...
  def test_SBase_appendAnnotation2(self):
    triple = libsbml.XMLTriple("any", "", "pr")
    att = libsbml.XMLAttributes()
    ns = libsbml.XMLNamespaces()
    ns.add( "http://www.any", "pr")
    ...
    self.assertTrue( t1.getNumChildren() == 2 )
    self.assertTrue((     "This is a test note" == t1.getChild(0).getChild(0).getCharacters() ))
    c1 = t1.getChild(1).getChild(0)
    self.assertTrue( c1.getNumChildren() == 0 )
    self.assertTrue((  "This is additional" == c1.getCharacters() ))
    newann = wrapString("<annotation>" + 
    ...
    "</annotation>")
    i = self.S.appendAnnotation(newann)
    self.assertTrue( i == libsbml.LIBSBML_DUPLICATE_ANNOTATION_NS )
    t1 = self.S.getAnnotation()
    self.assertTrue( t1.getNumChildren() == 3 )
    self.assertTrue((     "This is a test note" == t1.getChild(0).getChild(0).getCharacters() ))
    self.assertTrue((     "This is additional" == t1.getChild(1).getChild(0).getCharacters() ))
    self.assertTrue((     "This is a new annotation" == t1.getChild(2).getChild(0).getCharacters() ))
    _dummyList = [ triple ]; _dummyList[:] = []; del _dummyList
    _dummyList = [ att ]; _dummyList[:] = []; del _dummyList
    _dummyList = [ ns ]; _dummyList[:] = []; del _dummyList
    _dummyList = [ token_top ]; _dummyList[:] = []; del _dummyList
  ...
  def test_SBase_setNotes(self):
    ...
    i = self.S.unsetNotes()
    self.assertTrue( i == libsbml.LIBSBML_OPERATION_SUCCESS )
    self.assertTrue( self.S.isSetNotes() == False )
    _dummyList = [ token ]; _dummyList[:] = []; del _dummyList
    _dummyList = [ node ]; _dummyList[:] = []; del _dummyList
    token = libsbml.XMLToken("This is a test note")
    node = libsbml.XMLNode(token)
  ...
  def test_SBase_setSBOTerm2(self):
    ...
    sboid = self.S.getSBOTermID()
    self.assertTrue( (  "SBO:0000005" != sboid ) == False )
    str = self.S.getSBOTermAsURL()
    self.assertTrue( (                 "http://identifiers.org/biomodels.sbo/SBO:0000005" != str ) == False )
    i = self.S.unsetSBOTerm()
    self.assertTrue( i == libsbml.LIBSBML_OPERATION_SUCCESS )
    self.assertEqual( False, self.S.isSetSBOTerm() )
    self.assertTrue( self.S.getSBOTerm() == -1 )
    self.assertTrue( self.S.getSBOTermID() == "" )
    self.assertTrue( self.S.getSBOTermAsURL() == None )
    i = self.S.setSBOTerm(0)
    self.assertTrue( i == libsbml.LIBSBML_OPERATION_SUCCESS )
    self.assertEqual( True, self.S.isSetSBOTerm() )
    self.assertTrue( self.S.getSBOTerm() == 0 )
    sboid = self.S.getSBOTermID()
    self.assertTrue( (  "SBO:0000000" != sboid ) == False )
    str = self.S.getSBOTermAsURL()
    self.assertTrue( (                 "http://identifiers.org/biomodels.sbo/SBO:0000000" != str ) == False )
    i = self.S.setSBOTerm(9999999)
    self.assertTrue( i == libsbml.LIBSBML_OPERATION_SUCCESS )
    self.assertEqual( True, self.S.isSetSBOTerm() )
    self.assertTrue( self.S.getSBOTerm() == 9999999 )
    sboid = self.S.getSBOTermID()
    self.assertTrue( (  "SBO:9999999" != sboid ) == False )
    str = self.S.getSBOTermAsURL()
    self.assertTrue( (                 "http://identifiers.org/biomodels.sbo/SBO:9999999" != str ) == False )
