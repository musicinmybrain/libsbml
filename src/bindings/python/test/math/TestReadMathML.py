...
class TestReadMathML(unittest.TestCase):
  ...
  def test_convert_unary_plus(self):
    s = wrapMathML("<apply><plus/><cn>1</cn></apply>"  
    )
    self.N = libsbml.readMathMLFromString(s)
    self.assertTrue( self.N != None )
    result = libsbml.formulaToString(self.N)
    self.assertTrue( result != None )
    self.N = None
    self.N = libsbml.parseFormula(result)
    self.assertTrue( self.N != None )
    pass  
  ...
  def test_element_child_func(self):
    s = wrapMathML("<apply>" + 
    "  <cos/>" + 
    "  <apply>" + 
    "    <power/>" + 
    ...
    self.assertTrue( self.N != None )
    self.F = libsbml.formulaToString(self.N)
    self.assertTrue((  "cos(pow(x, 2))" == self.F ))
    child = self.N.getChild(0)
    c1 = libsbml.ASTNode(libsbml.AST_NAME)
    c1.setName("y")
    child.replaceChild(0,c1,True)
    self.F = libsbml.formulaToString(self.N)
    self.assertTrue((  "cos(pow(y, 2))" == self.F ))
    pass  

  def test_element_child_func1(self):
    self.N = libsbml.ASTNode(libsbml.AST_FUNCTION_COS)
    pow = libsbml.ASTNode(libsbml.AST_FUNCTION_POWER)
    x = libsbml.ASTNode(libsbml.AST_NAME)
    x.setName("x")
    two = libsbml.ASTNode(libsbml.AST_REAL)
    two.setValue(2.0)
    pow.addChild(x)
    pow.addChild(two)
    self.N.addChild(pow)
  ...
  def test_element_cn_class(self):
    s = wrapMathML("<cn class=\"test\"> 12345.7 </cn>")
    self.N = libsbml.readMathMLFromString(s)
    self.assertTrue( self.N != None )
    self.assertTrue( self.N.getType() == libsbml.AST_REAL )
    self.assertEqual( True, util_isEqual )
    self.assertTrue( self.N.getClass() ==  "test"    )
    self.assertTrue( self.N.getNumChildren() == 0 )
    pass  
  ...
  def test_element_cn_id(self):
    s = wrapMathML("<cn id=\"test\"> 12345.7 </cn>")
    self.N = libsbml.readMathMLFromString(s)
    self.assertTrue( self.N != None )
    self.assertTrue( self.N.getType() == libsbml.AST_REAL )
    self.assertEqual( True, util_isEqual )
    self.assertTrue( self.N.getId() ==  "test"    )
    self.assertTrue( self.N.getNumChildren() == 0 )
    pass  
  ...
  def test_element_cn_style(self):
    s = wrapMathML("<cn style=\"test\"> 12345.7 </cn>")
    self.N = libsbml.readMathMLFromString(s)
    self.assertTrue( self.N != None )
    self.assertTrue( self.N.getType() == libsbml.AST_REAL )
    self.assertEqual( True, util_isEqual )
    self.assertTrue( self.N.getStyle() ==  "test"    )
    self.assertTrue( self.N.getNumChildren() == 0 )
    pass  
  ...
  def test_element_csymbol_delay_4(self):
    s = wrapMathML("<apply>" + 
    "  <csymbol encoding='text' definitionURL='http://www.sbml.org/sbml/" + 
    "symbols/delay'> my_delay </csymbol>" + 
    "  <ci> x </ci>" + 
    ...
    self.assertTrue( self.N != None )
    self.F = libsbml.formulaToString(self.N)
    self.assertTrue((  "my_delay(x)" == self.F ))
    pass  

  def test_element_csymbol_other(self):
    s = wrapMathML("<csymbol encoding='text' " + "definitionURL='http://www.other/symbols/foo'> NA </csymbol>")
    self.N = libsbml.readMathMLFromString(s)
    self.assertTrue( self.N != None )
    self.assertTrue( self.N.getType() == libsbml.AST_CSYMBOL_FUNCTION )
    self.assertTrue((  "NA" == self.N.getName() ))
    self.assertTrue( self.N.getNumChildren() == 0 )
    pass  

  def test_element_csymbol_other_withNS(self):
    s = wrapMathML("<csymbol encoding='text' " + "definitionURL='http://www.other/symbols/foo'> NA </csymbol>")
    xmlns = libsbml.XMLNamespaces()
    xmlns.add("any_uri")
    self.N = readMathMLFromStringWithNamespaces
    self.assertTrue( self.N == None )
    xmlns = None
    pass  

  def test_element_csymbol_other_withNS_1(self):
    s = wrapMathML("<apply>""<csymbol encoding='text' " + 
    ...
    self.assertTrue( self.N.getType() == libsbml.AST_CSYMBOL_FUNCTION )
    self.assertTrue((  "NA" == self.N.getName() ))
    self.assertTrue((  "http://www.other/symbols/foo" == self.N.getDefinitionURLString() ))
    self.F = libsbml.formulaToString(self.N)
    self.assertTrue((  "NA(y)" == self.F ))
    xmlns = None
    DefinitionURLRegistry.getInstance().clearDefinitions()
    pass  

  def test_element_csymbol_rateof_1(self):
    s = wrapMathML("<csymbol encoding='text' " + "definitionURL='http://www.sbml.org/sbml/symbols/rateOf'> rateOf </csymbol>")
    self.N = libsbml.readMathMLFromString(s)
    self.assertTrue( self.N != None )
    self.assertTrue( self.N.getType() == libsbml.AST_FUNCTION_RATE_OF )
    self.assertTrue((  "rateOf" == self.N.getName() ))
    self.assertTrue( self.N.getNumChildren() == 0 )
    pass  

  def test_element_csymbol_rateof_2(self):
    s = wrapMathML("<apply>" + 
    "  <csymbol encoding='text' definitionURL='http://www.sbml.org/sbml/" + 
    ...
    self.assertTrue( self.N != None )
    self.F = libsbml.formulaToString(self.N)
    self.assertTrue((  "my_rateof(x)" == self.F ))
    pass  

  def test_element_csymbol_rateof_3(self):
    s = wrapMathML("<apply>" + 
    "  <power/>" + 
    "  <apply>" + 
    "    <csymbol encoding='text' definitionURL='http://www.sbml.org/sbml/" + 
    ...
    self.assertTrue( self.N != None )
    self.F = libsbml.formulaToString(self.N)
    self.assertTrue((  "pow(rateof(P), q)" == self.F ))
    pass  

  def test_element_csymbol_rateof_4(self):
    s = wrapMathML("<apply>" + 
    "  <csymbol encoding='text' definitionURL='http://www.sbml.org/sbml/" + 
    "symbols/rateOf'> my_rateof </csymbol>" + 
    "  <ci> x </ci>" + 
  ...
  def test_element_generic_csymbol_1(self):
    s = wrapMathML("<csymbol encoding='text' " + "definitionURL='http://www.sbml.org/sbml/symbols/unknown/URL'> unknown_function </csymbol>")
    self.N = libsbml.readMathMLFromString(s)
    self.assertTrue( self.N != None )
    self.assertTrue( self.N.getType() == libsbml.AST_CSYMBOL_FUNCTION )
    self.assertTrue((  "unknown_function" == self.N.getName() ))
    self.assertTrue((  "http://www.sbml.org/sbml/symbols/unknown/URL" == self.N.getDefinitionURLString() ))
    self.assertTrue( self.N.getNumChildren() == 0 )
    pass  

  def test_element_generic_csymbol_2(self):
    s = wrapMathML("<apply>" + 
    "<csymbol encoding='text' " + 
    ...
    self.assertTrue( self.N != None )
    self.F = libsbml.formulaToString(self.N)
    self.assertTrue((  "unknown_function(x, y)" == self.F ))
    pass  

  def test_element_generic_csymbol_3(self):
    s = wrapMathML("<apply>" + 
    "  <power/>" + 
    "  <apply>" + 
    "<csymbol encoding='text' " + 
    ...
    self.assertTrue( self.N != None )
    self.F = libsbml.formulaToString(self.N)
    self.assertTrue((  "pow(unknown_function(P, Q), q)" == self.F ))
    pass  
  ...
  def test_element_implies(self):
    s = wrapMathML("<apply> <implies/> <ci>a</ci> <ci>b</ci> </apply>"  
    )
    self.N = libsbml.readMathMLFromString(s)
    self.assertTrue( self.N != None )
    self.F = libsbml.formulaToString(self.N)
    self.assertTrue((  "implies(a, b)" == self.F ))
    pass  
  ...
  def test_element_max(self):
    s = wrapMathML("<apply> <max/> <ci>a</ci> <ci>b</ci> </apply>"  
    )
    self.N = libsbml.readMathMLFromString(s)
    self.assertTrue( self.N != None )
    self.F = libsbml.formulaToString(self.N)
    self.assertTrue((  "max(a, b)" == self.F ))
    pass  

  def test_element_min(self):
    s = wrapMathML("<apply> <min/> <ci>a</ci> <ci>b</ci> </apply>"  
    )
    self.N = libsbml.readMathMLFromString(s)
    self.assertTrue( self.N != None )
    self.F = libsbml.formulaToString(self.N)
    self.assertTrue((  "min(a, b)" == self.F ))
    pass  
  ...
  def test_element_piecewise_no_args_1(self):
    s = wrapMathML("<piecewise>" + "</piecewise>")
    self.N = libsbml.readMathMLFromString(s)
    self.assertTrue( self.N != None )
    self.F = libsbml.formulaToString(self.N)
    self.assertTrue((  "piecewise()" == self.F ))
    pass  

  def test_element_piecewise_no_args_2(self):
    s = wrapMathML("<piecewise/>"  
    )
    self.N = libsbml.readMathMLFromString(s)
    self.assertTrue( self.N != None )
  ...
  def test_element_piecewise_one_arg(self):
    s = wrapMathML("<piecewise>" + 
    "  <otherwise>" + 
    "    <ci>x</ci>" + 
    "  </otherwise>" + 
    ...
    self.assertTrue( self.N != None )
    self.F = libsbml.formulaToString(self.N)
    self.assertTrue((  "piecewise(x)" == self.F ))
    pass  
  ...
  def test_element_quotient(self):
    s = wrapMathML("<apply> <quotient/> <ci>a</ci> <ci>b</ci> </apply>"  
    )
    self.N = libsbml.readMathMLFromString(s)
    self.assertTrue( self.N != None )
    self.F = libsbml.formulaToString(self.N)
    self.assertTrue((  "quotient(a, b)" == self.F ))
    pass  

  def test_element_rem(self):
    s = wrapMathML("<apply> <rem/> <ci>a</ci> <ci>b</ci> </apply>"  
    )
    self.N = libsbml.readMathMLFromString(s)
    self.assertTrue( self.N != None )
    self.F = libsbml.formulaToString(self.N)
    self.assertTrue((  "rem(a, b)" == self.F ))
    pass  
