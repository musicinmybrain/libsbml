...
class TestSyncAnnotation(unittest.TestCase):
  ...
  def test_SyncAnnotation_modifyBoth_1(self):
    ...
    "</compartment>")
    sbml = c.toSBML()
    self.assertEqual( True, self.equals(expected2,sbml) )
    sbml = None
    mh = None
    cv = None
    pass  
  ...
  def test_SyncAnnotation_modifyBoth_4(self):
    ...
    "</compartment>")
    sbml = c.toSBML()
    self.assertEqual( True, self.equals(expected3,sbml) )
    sbml = None
    mh = None
    cv = None
    pass  
  ...
  def test_SyncAnnotation_nestedCV_invalid(self):
    c = libsbml.Compartment(2,4)
    c.setMetaId("_000012")
    c.setId("cc")
    c.setConstant(True)
    annot = wrapString("    <rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns:dc=\"http://purl.org/dc/elements/1.1/\" xmlns:dcterms=\"http://purl.org/dc/terms/\" xmlns:vCard=\"http://www.w3.org/2001/vcard-rdf/3.0#\" xmlns:bqbiol=\"http://biomodels.net/biology-qualifiers/\" xmlns:bqmodel=\"http://biomodels.net/model-qualifiers/\">\n" + 
    "      <rdf:Description rdf:about=\"#_000012\">\n" + 
    "        <bqbiol:is>\n" + 
    "          <rdf:Bag>\n" + 
    "            <rdf:li rdf:resource=\"http://www.geneontology.org/#GO:0007274\"/>\n" + 
  ...
  def test_SyncAnnotation_ordering_bug_1(self):
  ...
  def test_SyncAnnotation_ordering_bug_2(self):
    c = libsbml.Compartment(2,3)
    c.setMetaId("_000003")
    c.setId("A")
    cv = libsbml.CVTerm(libsbml.BIOLOGICAL_QUALIFIER)
  ...
  def test_SyncAnnotation_stringChangesMetaid1(self):
    c = libsbml.Model(2,3)
    c.setMetaId("_000005")
    c.setId("A")
    addedAnn = wrapString("  <annotation>\n" + 
  ...
  def test_SyncAnnotation_stringChangesMetaid2(self):
    c = libsbml.Compartment(2,3)
    c.setMetaId("_000005")
    c.setId("A")
    addedAnn = wrapString("  <annotation>\n" + 
  ...
  def test_SyncAnnotation_stringChangesMetaid3(self):
    c = libsbml.Model(3,1)
    c.setMetaId("_000005")
    c.setId("A")
    addedAnn = wrapString("  <annotation>\n" + 
