...
class TestDate_newSetters(unittest.TestCase):
  ...
  def test_Date_accessWithNULL(self):
    self.assertTrue( None.clone() == None )
    self.assertTrue( libsbml.Date(None) == None )
    _dummyList = [ None ]; _dummyList[:] = []; del _dummyList
    self.assertTrue( None.getDateAsString() == None )
    self.assertTrue( None.getDay() == SBML_INT_MAX )
    self.assertTrue( None.getHour() == SBML_INT_MAX )
    self.assertTrue( None.getHoursOffset() == SBML_INT_MAX )
    self.assertTrue( None.getMinute() == SBML_INT_MAX )
    self.assertTrue( None.getMinutesOffset() == SBML_INT_MAX )
    self.assertTrue( None.getMonth() == SBML_INT_MAX )
    self.assertTrue( None.getSecond() == SBML_INT_MAX )
    self.assertTrue( None.getSignOffset() == SBML_INT_MAX )
    self.assertTrue( None.getYear() == SBML_INT_MAX )
    self.assertTrue( None.representsValidDate() == 0 )
    self.assertTrue( None.setDateAsString("") == libsbml.LIBSBML_INVALID_OBJECT )
    self.assertTrue( None.setDay(0) == libsbml.LIBSBML_INVALID_OBJECT )
    self.assertTrue( None.setHour(0) == libsbml.LIBSBML_INVALID_OBJECT )
    self.assertTrue( None.setHoursOffset(0) == libsbml.LIBSBML_INVALID_OBJECT )
    self.assertTrue( None.setMinute(0) == libsbml.LIBSBML_INVALID_OBJECT )
    self.assertTrue( None.setMinutesOffset(0) == libsbml.LIBSBML_INVALID_OBJECT )
    self.assertTrue( None.setMonth(0) == libsbml.LIBSBML_INVALID_OBJECT )
    self.assertTrue( None.setSecond(0) == libsbml.LIBSBML_INVALID_OBJECT )
    self.assertTrue( None.setSignOffset(0) == libsbml.LIBSBML_INVALID_OBJECT )
    self.assertTrue( None.setYear(0) == libsbml.LIBSBML_INVALID_OBJECT )
    pass  
