...
class TestModelHistory(unittest.TestCase):
  ...
  def test_ModelHistory_accessWithNULL(self):
    self.assertTrue( None.addCreator(None) == libsbml.LIBSBML_INVALID_OBJECT )
    self.assertTrue( None.addModifiedDate(None) == libsbml.LIBSBML_INVALID_OBJECT )
    self.assertTrue( None.clone() == None )
    _dummyList = [ None ]; _dummyList[:] = []; del _dummyList
    self.assertTrue( None.getCreatedDate() == None )
    self.assertTrue( None.getCreator(0) == None )
    self.assertTrue( None.getListCreators() == None )
    self.assertTrue( None.getListModifiedDates() == None )
    self.assertTrue( None.getModifiedDate() == None )
    self.assertTrue( None.getModifiedDate(0) == None )
    self.assertTrue( None.getNumCreators() == SBML_INT_MAX )
    self.assertTrue( None.getNumModifiedDates() == SBML_INT_MAX )
    self.assertTrue( None.hasRequiredAttributes() == 0 )
    self.assertTrue( None.isSetCreatedDate() == False )
    self.assertTrue( None.isSetModifiedDate() == False )
    self.assertTrue( None.setCreatedDate(None) == libsbml.LIBSBML_INVALID_OBJECT )
    self.assertTrue( None.setModifiedDate(None) == libsbml.LIBSBML_INVALID_OBJECT )
    pass  
