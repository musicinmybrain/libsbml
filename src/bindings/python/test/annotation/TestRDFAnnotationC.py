...
class TestRDFAnnotationC(unittest.TestCase):
  ...
  def test_RDFAnnotation_C_accessWithNULL(self):
    self.assertTrue( libsbml.RDFAnnotationParser.createCVTerms(None) == None )
    self.assertTrue( libsbml.RDFAnnotationParser.createRDFDescription(None) == None )
    self.assertTrue( libsbml.RDFAnnotationParser.deleteRDFAnnotation(None) == None )
    self.assertTrue( libsbml.RDFAnnotationParser.parseCVTerms(None) == None )
    self.assertTrue( libsbml.RDFAnnotationParser.parseModelHistory(None) == None )
    libsbml.RDFAnnotationParser.parseRDFAnnotation(None,None)
    self.assertTrue( libsbml.RDFAnnotationParser.parseRDFAnnotationWithModelHistory(None) == None )
    pass  
  ...
  def test_RDFAnnotation_C_parseModelHistory(self):
    ...
    self.assertTrue((  "http://purl.org/dc/elements/1.1/" == creator.getURI() ))
