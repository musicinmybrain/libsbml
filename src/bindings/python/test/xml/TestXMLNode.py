...
class TestXMLNode(unittest.TestCase):
  ...
  def test_XMLNode_convert(self):
    ...
    test = attr.getName(0)
    self.assertTrue( (  "id"    != test ) == False )
    test = None
    test = attr.getValue(0)
    self.assertTrue( (  "test"  != test ) == False )
    test = None
    test = ns.getURI(0)
    self.assertTrue( (  "http://test.org/"  != test ) == False )
    test = None
  ...
  def test_XMLNode_createElement(self):
    ...
    self.assertTrue( (  "value" != test ) == False )
    test = None
  ...
  def test_XMLNode_equals(self):
    xmlstr = wrapString("<annotation>\n" + "  <test xmlns=\"http://test.org/\" id=\"test\">test</test>\n" + "</annotation>")
    node = libsbml.XMLNode()
    node1 = libsbml.XMLNode.convertStringToXMLNode(xmlstr,None)
    self.assertEqual( False, node.equals(node1) )
    _dummyList = [ node ]; _dummyList[:] = []; del _dummyList
    node2 = libsbml.XMLNode.convertStringToXMLNode(xmlstr,None)
    self.assertEqual( True, node2.equals(node1) )
    _dummyList = [ node1 ]; _dummyList[:] = []; del _dummyList
    _dummyList = [ node2 ]; _dummyList[:] = []; del _dummyList
    pass  

  def test_XMLNode_getChildForName(self):
    xmlstr = wrapString("<annotation>\n" + "  <test xmlns=\"http://test.org/\" id=\"test\">test</test>\n" + "</annotation>")
    node = libsbml.XMLNode()
    ...
    node = libsbml.XMLNode.convertStringToXMLNode(xmlstr,None)
    annotation = node.getChild("test")
    self.assertTrue( ( "test" != annotation.getName() ) == False )
    _dummyList = [ node ]; _dummyList[:] = []; del _dummyList
    pass  

  def test_XMLNode_getIndex(self):
    xmlstr = wrapString("<annotation>\n" + "  <test xmlns=\"http://test.org/\" id=\"test\">test</test>\n" + "</annotation>")
    node = libsbml.XMLNode()
    self.assertTrue( node.getIndex( "test") == -1 )
    _dummyList = [ node ]; _dummyList[:] = []; del _dummyList
    node = libsbml.XMLNode.convertStringToXMLNode(xmlstr,None)
    self.assertTrue( node.getIndex( "test") == 0 )
    _dummyList = [ node ]; _dummyList[:] = []; del _dummyList
    pass  
  ...
  def test_XMLNode_getters(self):
    ...
    self.assertTrue( (  "attr2" != test ) == False )
    test = None
  ...
  def test_XMLNode_hasChild(self):
    xmlstr = wrapString("<annotation>\n" + "  <test xmlns=\"http://test.org/\" id=\"test\">test</test>\n" + "</annotation>")
    node = libsbml.XMLNode()
    self.assertTrue( node.hasChild( "test") == (int)false )
    _dummyList = [ node ]; _dummyList[:] = []; del _dummyList
    node = libsbml.XMLNode.convertStringToXMLNode(xmlstr,None)
    self.assertTrue( node.hasChild( "test") == (int)true )
    _dummyList = [ node ]; _dummyList[:] = []; del _dummyList
    pass  
  ...
  def test_XMLNode_namespace_add(self):
    ...
    self.assertTrue( node.getNamespacesLength() == 3 )
    self.assertTrue( node.isNamespacesEmpty() == False )
    self.assertFalse(node.getNamespaceIndex( "http://test1.org/") == -1)
    _dummyList = [ node ]; _dummyList[:] = []; del _dummyList
    _dummyList = [ triple ]; _dummyList[:] = []; del _dummyList
    _dummyList = [ attr ]; _dummyList[:] = []; del _dummyList
    pass  
