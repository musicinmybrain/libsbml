...
class TestXMLErrorC(unittest.TestCase):
  ...
  def test_XMLError_accessWithNULL(self):
    _dummyList = [ None ]; _dummyList[:] = []; del _dummyList
    self.assertTrue( libsbml.XMLError(0,None) == None )
    self.assertTrue( None.getCategory() == SBML_INT_MAX )
    self.assertTrue( None.getCategoryAsString() == "" )
    self.assertTrue( None.getColumn() == 0 )
    self.assertTrue( None.getErrorId() == SBML_INT_MAX )
    self.assertTrue( None.getLine() == 0 )
    self.assertTrue( None.getMessage() == "" )
    self.assertTrue( None.getSeverity() == SBML_INT_MAX )
    self.assertTrue( None.getSeverityAsString() == "" )
    self.assertTrue( None.getShortMessage() == None )
    self.assertTrue( None.isError() == False )
    self.assertTrue( None.isFatal() == False )
    self.assertTrue( None.isInfo() == False )
    self.assertTrue( None.isWarning() == False )
    None.print(None)
    pass  
