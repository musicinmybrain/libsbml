...
class TestXMLOutputStream(unittest.TestCase):
  ...
  def test_XMLOutputStream_accessWithNULL(self):
    self.assertTrue( libsbml.XMLOutputStream(libsbml.cout,None,False) == None )
    self.assertTrue( libsbml.XMLOutputStream(libsbml.cout,None,False,None,None) == None )
    oss = libsbml.ostringstream()
    self.assertTrue( libsbml.XMLOutputStream(oss,None,False) == None )
    oss = libsbml.ostringstream()
    self.assertTrue( libsbml.XMLOutputStream(oss,None,False,None,None) == None )
    self.assertTrue( libsbml.XMLOutputStream(libsbml.createOFStream(None),None,False) == None )
    self.assertTrue( libsbml.XMLOutputStream(libsbml.createOFStream(None),None,False,None,None) == None )
    None.downIndent()
    None.endElement(None)
    None.endElementTriple(None)
    _dummyList = [ None ]; _dummyList[:] = []; del _dummyList
    self.assertTrue( oss.str() == None )
    None.setAutoIndent(0)
    None.startElement(None)
    None.startElementTriple(None)
    None.startEndElement(None)
    None.startEndElementTriple(None)
    None.upIndent()
    None.writeAttribute(None,0)
    None.writeAttribute(None,0)
    None.writeAttribute(None,None)
    None.writeAttribute(None,None)
    None.writeAttribute(None,0.0)
    None.writeAttribute(None,0.0)
    None.writeAttribute(None,0)
    None.writeAttribute(None,0)
    None.writeAttribute(None,0)
    ...
    None.writeAttribute(None,0)
    None.writeAttribute(None,0)
    None.writeChars(None)
    None.writeDouble(0.0)
    None.writeLong(0)
    None.writeXMLDecl()
    pass  
