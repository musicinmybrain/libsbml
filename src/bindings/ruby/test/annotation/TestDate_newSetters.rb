...
class TestDate_newSetters < Test::Unit::TestCase
  ...
  def test_Date_accessWithNULL
    assert( nil.clone() == nil )
    assert( LibSBML::Date.new(nil) == nil )
    assert( nil.getDateAsString() == nil )
    assert( nil.getDay() == @@SBML_INT_MAX )
    assert( nil.getHour() == @@SBML_INT_MAX )
    assert( nil.getHoursOffset() == @@SBML_INT_MAX )
    assert( nil.getMinute() == @@SBML_INT_MAX )
    assert( nil.getMinutesOffset() == @@SBML_INT_MAX )
    assert( nil.getMonth() == @@SBML_INT_MAX )
    assert( nil.getSecond() == @@SBML_INT_MAX )
    assert( nil.getSignOffset() == @@SBML_INT_MAX )
    assert( nil.getYear() == @@SBML_INT_MAX )
    assert( nil.representsValidDate() == 0 )
    assert( nil.setDateAsString("") == LibSBML::LIBSBML_INVALID_OBJECT )
    assert( nil.setDay(0) == LibSBML::LIBSBML_INVALID_OBJECT )
    assert( nil.setHour(0) == LibSBML::LIBSBML_INVALID_OBJECT )
    assert( nil.setHoursOffset(0) == LibSBML::LIBSBML_INVALID_OBJECT )
    assert( nil.setMinute(0) == LibSBML::LIBSBML_INVALID_OBJECT )
    assert( nil.setMinutesOffset(0) == LibSBML::LIBSBML_INVALID_OBJECT )
    assert( nil.setMonth(0) == LibSBML::LIBSBML_INVALID_OBJECT )
    assert( nil.setSecond(0) == LibSBML::LIBSBML_INVALID_OBJECT )
    assert( nil.setSignOffset(0) == LibSBML::LIBSBML_INVALID_OBJECT )
    assert( nil.setYear(0) == LibSBML::LIBSBML_INVALID_OBJECT )
  end
