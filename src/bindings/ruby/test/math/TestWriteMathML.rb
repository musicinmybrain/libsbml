...
class TestWriteMathML < Test::Unit::TestCase
  ...
  def test_MathMLFormatter_apply_cn_units
  ...
  def test_MathMLFormatter_apply_cn_units_old
    expected = wrapMathMLUnits("  <apply>\n" + 
    "    <divide/>\n" + 
    "    <cn sbml:units=\"mole\" type=\"integer\"> 3 </cn>\n" + 
    "    <cn sbml:units=\"dimensionless\" type=\"integer\"> 4 </cn>\n" + 
  ...
  def test_MathMLFormatter_ci_class
  ...
  def test_MathMLFormatter_ci_id
  ...
  def test_MathMLFormatter_ci_style
  ...
  def test_MathMLFormatter_csymbol_rateof
  end
