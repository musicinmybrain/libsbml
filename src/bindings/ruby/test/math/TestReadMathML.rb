...
class TestReadMathML < Test::Unit::TestCase
  ...
  def test_element_child_func
    ...
    assert( @@n != nil )
    @@f = LibSBML::formulaToString(@@n)
    assert ((  "cos(pow(x, 2))" == @@f ))
    child = @@n.getChild(0)
    c1 = LibSBML::ASTNode.new(LibSBML::AST_NAME)
    c1.setName("y")
    child.replaceChild(0,c1,true)
    @@f = LibSBML::formulaToString(@@n)
    assert ((  "cos(pow(y, 2))" == @@f ))
  end

  def test_element_child_func1
    @@n = LibSBML::ASTNode.new(LibSBML::AST_FUNCTION_COS)
    pow = LibSBML::ASTNode.new(LibSBML::AST_FUNCTION_POWER)
    x = LibSBML::ASTNode.new(LibSBML::AST_NAME)
    x.setName("x")
    two = LibSBML::ASTNode.new(LibSBML::AST_REAL)
    two.setValue(2.0)
    pow.addChild(x)
    pow.addChild(two)
    @@n.addChild(pow)
  ...
  def test_element_cn_style
    s = wrapMathML("<cn style=\"test\"> 12345.7 </cn>")
    @@n = LibSBML::readMathMLFromString(s)
    assert( @@n != nil )
    assert( @@n.getType() == LibSBML::AST_REAL )
    assert_equal true, util_isEqual
    assert( @@n.getStyle() ==  "test"    )
    assert( @@n.getNumChildren() == 0 )
  end
  ...
  def test_element_csymbol_delay_4
    s = wrapMathML("<apply>" + 
    "  <csymbol encoding='text' definitionURL='http://www.sbml.org/sbml/" + 
    "symbols/delay'> my_delay </csymbol>" + 
    "  <ci> x </ci>" + 
  ...
  def test_element_csymbol_other
    s = wrapMathML("<csymbol encoding='text' " + "definitionURL='http://www.other/symbols/foo'> NA </csymbol>")
    @@n = LibSBML::readMathMLFromString(s)
    assert( @@n != nil )
    assert( @@n.getType() == LibSBML::AST_CSYMBOL_FUNCTION )
    assert ((  "NA" == @@n.getName() ))
    assert( @@n.getNumChildren() == 0 )
  end

  def test_element_csymbol_other_withNS
    s = wrapMathML("<csymbol encoding='text' " + "definitionURL='http://www.other/symbols/foo'> NA </csymbol>")
  ...
  def test_element_csymbol_other_withNS_1
    ...
    assert( @@n.getType() == LibSBML::AST_CSYMBOL_FUNCTION )
    assert ((  "NA" == @@n.getName() ))
    assert ((  "http://www.other/symbols/foo" == @@n.getDefinitionURLString() ))
    @@f = LibSBML::formulaToString(@@n)
    assert ((  "NA(y)" == @@f ))
    xmlns = nil
  ...
  def test_element_csymbol_rateof_1
    s = wrapMathML("<csymbol encoding='text' " + "definitionURL='http://www.sbml.org/sbml/symbols/rateOf'> rateOf </csymbol>")
    @@n = LibSBML::readMathMLFromString(s)
    assert( @@n != nil )
    assert( @@n.getType() == LibSBML::AST_FUNCTION_RATE_OF )
    assert ((  "rateOf" == @@n.getName() ))
    assert( @@n.getNumChildren() == 0 )
  end

  def test_element_csymbol_rateof_2
    s = wrapMathML("<apply>" + 
    "  <csymbol encoding='text' definitionURL='http://www.sbml.org/sbml/" + 
    ...
    assert( @@n != nil )
    @@f = LibSBML::formulaToString(@@n)
    assert ((  "my_rateof(x)" == @@f ))
  end

  def test_element_csymbol_rateof_3
    s = wrapMathML("<apply>" + 
    "  <power/>" + 
    "  <apply>" + 
    "    <csymbol encoding='text' definitionURL='http://www.sbml.org/sbml/" + 
    ...
    assert( @@n != nil )
    @@f = LibSBML::formulaToString(@@n)
    assert ((  "pow(rateof(P), q)" == @@f ))
  end

  def test_element_csymbol_rateof_4
    s = wrapMathML("<apply>" + 
    "  <csymbol encoding='text' definitionURL='http://www.sbml.org/sbml/" + 
    "symbols/rateOf'> my_rateof </csymbol>" + 
    "  <ci> x </ci>" + 
  ...
  def test_element_generic_csymbol_1
    s = wrapMathML("<csymbol encoding='text' " + "definitionURL='http://www.sbml.org/sbml/symbols/unknown/URL'> unknown_function </csymbol>")
    @@n = LibSBML::readMathMLFromString(s)
    assert( @@n != nil )
    assert( @@n.getType() == LibSBML::AST_CSYMBOL_FUNCTION )
    assert ((  "unknown_function" == @@n.getName() ))
    assert ((  "http://www.sbml.org/sbml/symbols/unknown/URL" == @@n.getDefinitionURLString() ))
    assert( @@n.getNumChildren() == 0 )
  end

  def test_element_generic_csymbol_2
    s = wrapMathML("<apply>" + 
    "<csymbol encoding='text' " + 
    ...
    assert( @@n != nil )
    @@f = LibSBML::formulaToString(@@n)
    assert ((  "unknown_function(x, y)" == @@f ))
  end

  def test_element_generic_csymbol_3
    s = wrapMathML("<apply>" + 
    "  <power/>" + 
    "  <apply>" + 
    "<csymbol encoding='text' " + 
    ...
    assert( @@n != nil )
    @@f = LibSBML::formulaToString(@@n)
    assert ((  "pow(unknown_function(P, Q), q)" == @@f ))
  end
  ...
  def test_element_piecewise_no_args_1
  ...
  def test_element_piecewise_no_args_2
    s = wrapMathML("<piecewise/>"  
    )
    @@n = LibSBML::readMathMLFromString(s)
    assert( @@n != nil )
  ...
  def test_element_piecewise_one_arg
    s = wrapMathML("<piecewise>" + 
    "  <otherwise>" + 
    "    <ci>x</ci>" + 
    "  </otherwise>" + 
  ...
  def test_element_quotient
    s = wrapMathML("<apply> <quotient/> <ci>a</ci> <ci>b</ci> </apply>"  
    )
    @@n = LibSBML::readMathMLFromString(s)
    assert( @@n != nil )
    @@f = LibSBML::formulaToString(@@n)
    assert ((  "quotient(a, b)" == @@f ))
  end

  def test_element_rem
