...
class TestXMLOutputStream < Test::Unit::TestCase
  ...
  def test_XMLOutputStream_accessWithNULL
    assert( LibSBML::XMLOutputStream.new(LibSBML::cout,nil,false) == nil )
    assert( LibSBML::XMLOutputStream.new(LibSBML::cout,nil,false,nil,nil) == nil )
    oss = LibSBML::Ostringstream.new
    assert( LibSBML::XMLOutputStream.new(oss,nil,false) == nil )
    oss = LibSBML::Ostringstream.new
    assert( LibSBML::XMLOutputStream.new(oss,nil,false,nil,nil) == nil )
    assert( LibSBML::XMLOutputStream.new(LibSBML::ostream.new(nil),nil,false) == nil )
    assert( LibSBML::XMLOutputStream.new(LibSBML::ostream.new(nil),nil,false,nil,nil) == nil )
    nil.downIndent()
    nil.endElement(nil)
    nil.endElementTriple(nil)
    assert( oss.str() == nil )
    nil.setAutoIndent(0)
    nil.startElement(nil)
    nil.startElementTriple(nil)
    nil.startEndElement(nil)
    nil.startEndElementTriple(nil)
    nil.upIndent()
    nil.writeAttribute(nil,0)
    nil.writeAttribute(nil,0)
    nil.writeAttribute(nil,nil)
    nil.writeAttribute(nil,nil)
    nil.writeAttribute(nil,0.0)
    nil.writeAttribute(nil,0.0)
    nil.writeAttribute(nil,0)
    nil.writeAttribute(nil,0)
    nil.writeAttribute(nil,0)
