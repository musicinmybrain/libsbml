...
class TestReadFromFileL2V5 < Test::Unit::TestCase

  def test_echo_l2v5_all
  ...
  def test_read_l2v5_all
    ...
    assert( d.getLevel() == 2 )
    assert( d.getVersion() == 5 )
    m = d.getModel()
    assert( m != nil )
    assert( m.getId() ==  "l2v5_all" )
