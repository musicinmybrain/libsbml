...
class TestCopyAndClone < Test::Unit::TestCase
  ...
  def test_Compartment_assignmentOperator_L3
    o1 = LibSBML::Compartment.new(3,1)
    o1.setId("c")
    o1.setSpatialDimensions(2.5)
    o1.setSize(2)
    assert( o1.getId() ==  "c" )
    assert( o1.getSpatialDimensionsAsDouble() == 2.5 )
    assert( o1.isSetSpatialDimensions() == true )
    assert( o1.getConstant() == true )
    assert( o1.isSetConstant() == false )
    o2 = LibSBML::Compartment.new(3,1)
    o2 = o1
    assert( o2.getId() ==  "c" )
    assert( o2.getSpatialDimensionsAsDouble() == 2.5 )
    assert( o2.isSetSpatialDimensions() == true )
    assert( o2.getConstant() == true )
    assert( o2.isSetConstant() == false )
    assert( o2.getParentSBMLObject() == o1.getParentSBMLObject() )
    o2 = nil
    o1 = nil
  end
  ...
  def test_Compartment_copyConstructor_L3
    o1 = LibSBML::Compartment.new(3,1)
    o1.setId("c")
    o1.setSpatialDimensions(2.5)
    o1.setSize(2)
  ...
  def test_Event_assignmentOperator_L3
    o1 = LibSBML::Event.new(3,1)
    o1.setId("c")
    o1.setUseValuesFromTriggerTime(false)
    assert( o1.getId() ==  "c" )
    assert( o1.getUseValuesFromTriggerTime() == false )
    assert( o1.isSetUseValuesFromTriggerTime() == true )
    o2 = LibSBML::Event.new(2,4)
    o2 = o1
    assert( o2.getId() ==  "c" )
    assert( o2.getUseValuesFromTriggerTime() == false )
    assert( o2.isSetUseValuesFromTriggerTime() == true )
    assert( o2.getParentSBMLObject() == o1.getParentSBMLObject() )
    o2 = nil
    o1 = nil
  end
  ...
  def test_Event_copyConstructor_L3
    o1 = LibSBML::Event.new(3,1)
    o1.setId("c")
    assert( o1.getId() ==  "c" )
    assert( o1.getUseValuesFromTriggerTime() == true )
    assert( o1.isSetUseValuesFromTriggerTime() == false )
    o2 = LibSBML::Event.new(o1)
    assert( o2.getId() ==  "c" )
    assert( o2.getUseValuesFromTriggerTime() == true )
    assert( o2.isSetUseValuesFromTriggerTime() == false )
    assert( o2.getParentSBMLObject() == o1.getParentSBMLObject() )
    o2 = nil
    o1 = nil
  end
