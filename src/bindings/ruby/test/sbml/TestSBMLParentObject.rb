...
class TestSBMLParentObject < Test::Unit::TestCase
  ...
  def test_CompartmentType_parent_mismatch
    ct = LibSBML::CompartmentType.new(2,4)
    m = LibSBML::Model.new(3,1)
    ct.setId("ct")
    success = m.addCompartmentType(ct)
    assert( success == LibSBML::LIBSBML_LEVEL_MISMATCH )
    ct = nil
    m = nil
  end
  ...
  def test_Compartment_parent_mismatch
    c = LibSBML::Compartment.new(2,3)
    c.setId("c")
    m = LibSBML::Model.new(2,4)
    success = m.addCompartment(c)
    assert( success == LibSBML::LIBSBML_VERSION_MISMATCH )
    c = nil
    m = nil
  end
  ...
  def test_Constraint_parent_mismatch
    ct = nil
    m = LibSBML::Model.new(2,4)
    success = m.addConstraint(ct)
    assert( success == LibSBML::LIBSBML_OPERATION_FAILED )
    ct = nil
    m = nil
  end
  ...
  def test_Delay_parent_mismatch
    e = LibSBML::Event.new(3,1)
    d = nil
    success = e.setDelay(d)
    assert( success == LibSBML::LIBSBML_OPERATION_SUCCESS )
    e = nil
    d = nil
  end
  ...
  def test_EventAssignment_parent_mismatch
    ...
    assert( success == LibSBML::LIBSBML_NAMESPACES_MISMATCH )
    e = nil
    ea = nil
  end
  ...
  def test_Event_parent_mismatch
    e = LibSBML::Event.new(3,1)
    m = LibSBML::Model.new(3,1)
    success = m.addEvent(e)
    assert( success == LibSBML::LIBSBML_INVALID_OBJECT )
    e = nil
    m = nil
  end
  ...
  def test_KineticLaw_parent_mismatch
    kl = LibSBML::KineticLaw.new(2,3)
    math = LibSBML::parseFormula("true")
    kl.setMath(math)
    math = nil
    r = LibSBML::Reaction.new(2,4)
  ...
  def test_Model_parent_mismatch
    sbmlns = LibSBML::SBMLNamespaces.new( 3,1 )
    d = LibSBML::SBMLDocument.new(sbmlns)
    sbmlns.addNamespace("http://www.sbml.org/sbml/level3/version1/comp/version1", "comp")
  ...
  def test_Priority_parent_mismatch
    e = LibSBML::Event.new(3,1)
    p = Priority.new(3,1)
    math = LibSBML::parseFormula("K+L")
    p.setMath(math)
  ...
  def test_StoichiometryMath_parent_mismatch
    m = LibSBML::StoichiometryMath.new(2,4)
    sr = LibSBML::SpeciesReference.new(2,4)
  ...
  def test_Trigger_parent_mismatch
    e = LibSBML::Event.new(3,1)
    t = LibSBML::Trigger.new(2,4)
    math = LibSBML::parseFormula("true")
    t.setMath(math)
