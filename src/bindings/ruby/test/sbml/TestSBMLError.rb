...
class TestSBMLError < Test::Unit::TestCase
  ...
  def test_SBMLErrorLog_getErrorWithSeverity
    log.add(LibSBML::SBMLError.new(ConstraintContainsXMLDecl))
    log.add(LibSBML::SBMLError.new(LibSBML::EmptyListInReaction))
    log.add(LibSBML::SBMLError.new(LibSBML::OverdeterminedSystem,2,1))
    log.add(LibSBML::SBMLError.new(LibSBML::OffsetNoLongerValid,2,2))
    log.add(LibSBML::SBMLError.new(LibSBML::NoSBOTermsInL1,2,2))
    log.add(LibSBML::SBMLError.new(LibSBML::DisallowedMathMLEncodingUse,2,2))
    log.add(LibSBML::SBMLError.new(LibSBML::DisallowedMathMLEncodingUse,1,2))
    log.add(LibSBML::SBMLError.new(LibSBML::UnknownError,2,4))
    log.add(LibSBML::SBMLError.new(70912,2,4))
