# @file    TestReadFromFileL3V2_6.rb
...
class TestReadFromFileL3V2_6 < Test::Unit::TestCase

  def test_echo_l3v2_empty_event2
    ...
    assert( e.isSetPriority() == false )
    assert( e.isSetDelay() == false )
  ...
  def test_read_l3v2_empty_event2
