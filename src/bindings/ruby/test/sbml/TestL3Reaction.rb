...
class TestL3Reaction < Test::Unit::TestCase
  ...
  def test_L3V2_Reaction_create
    assert( @@r32.getTypeCode() == LibSBML::SBML_REACTION )
    assert( @@r32.getMetaId() == "" )
    assert( @@r32.getNotes() == nil )
    assert( @@r32.getAnnotation() == nil )
    assert( @@r32.getId() == "" )
    assert( @@r32.getName() == "" )
    assert( @@r32.getCompartment() == "" )
    assert( @@r32.getFast() == false )
    assert( @@r32.getReversible() == true )
    assert_equal false, @@r32.isSetId()
    assert_equal false, @@r32.isSetName()
    assert_equal false, @@r32.isSetCompartment()
    assert_equal false, @@r32.isSetFast()
    assert_equal false, @@r32.isSetReversible()
  end

  def test_L3V2_Reaction_fast
    assert( @@r32.isSetFast() == false )
    i = @@r32.setFast(true)
  ...
  def test_L3V2_Reaction_hasRequiredAttributes
    r = LibSBML::Reaction.new(3,2)
